        ...
        <section>
            <form name="frmDocMasterTemplate" method ="post" action="">
                ...
                <input type="hidden" name="doc_master_template_oid" value="<%=oidDocMasterTemplate%>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <textarea id="editor1" name="<%=frmDocMasterTemplate.fieldNames[frmDocMasterTemplate.FRM_FIELD_TEXT_TEMPLATE]%>" class="elemenForm" cols="70" rows="40"><%= docMasterTemplateObj.getText_template()%></textarea>
                        </div>
                    </div>                      
                    <div class="row">
                        <div class="col-md-12">
                            <div class="modal-footer clearfix">
                                <button type="button" class="btn btn-danger pull-left" onclick="javascript:cmdSave()" id="togglee"></i> Save</button>
                            </div>
                        </div>
                </div>                             
            </form>
