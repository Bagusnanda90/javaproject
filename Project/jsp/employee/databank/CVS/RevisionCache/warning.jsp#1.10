...
<%!
	...
	public String drawList(Vector objectClass ,  long empWarningId, boolean privUpdate)
...
<script>
   ...
   function pageLoad(){ loadCompany('<%=oidWarning%>'); }  
</script>
</head>
    ...
    <div class="header">
        ...
        <div class="content-main">
            <form name="fredit" method="post" action="">
                ...
                <div class="content">
                    <div><%=drawList(listWarning, oidWarning, privUpdate)%></div>
                    <div><%
