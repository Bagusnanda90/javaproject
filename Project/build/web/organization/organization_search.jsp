    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function loadDivision() {
                ...
                xmlhttp.open("GET", "organization_available.jsp?select_structure.jsp", true);
                xmlhttp.send();
            }

            function loadDepartment(struct, comp_id, divisi_id) {
                if ((comp_id.length == 0)&&(divisi_id.length == 0)) { 
                    ...
                    xmlhttp.open("GET", "organization_available.jsp?select_structure="+struct+"&company_id="+comp_id+"&division_id=" + divisi_id, true);
                    xmlhttp.send();
                }
            }
            function loadSection(struct, comp_id, divisi_id, depart_id) {
                if ((comp_id.length == 0)&&(divisi_id.length == 0)&&(depart_id.length == 0)) { 
                    ...
                    xmlhttp.open("GET", "organization_available.jsp?select_structure="+struct+"&company_id="+comp_id+"&division_id=" + divisi_id +"&department_id="+depart_id, true);
                    xmlhttp.send();
                }
            }
            function clickSection(struct, comp_id, divisi_id, depart_id, sect_id){
                if ((comp_id.length == 0)&&(divisi_id.length == 0)&&(depart_id.length == 0)&&(sect_id.length == 0)) { 
                    ...
                    xmlhttp.open("GET", "organization_available.jsp?select_structure="+struct+"&company_id="+comp_id+"&division_id=" + divisi_id +"&department_id="+depart_id+"&section_id="+sect_id, true);
                    xmlhttp.send();
                }
            }
        </script>
