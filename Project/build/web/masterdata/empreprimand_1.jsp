<%-- 
    ...
    Created on : 14-Jun-2016, 15:40:40
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Reprimand | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Reprimand List</strong>
                                            <hr />
                                            <div id="listdata">
                                                </div>
                                        </div>
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showrepform" data-command="0"> Add New Reprimand</button>
                                        </div>
                                    </div>
                                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/empreprimand_ajax.jsp", dataSend, onDone, onSuccess);
			...
			if(dataFor == 'showrepform'){
			    $(".addeditgeneral-title").html("Edit Reprimand");
                       ...
                       sendData("<%= approot %>/masterdata/ajax/empreprimand_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
