<%-- 
    Document   : Language
    Created on : Aug 15, 2016, 2:36:26 PM
    Author     : ARYS
--%>
...
<%-- 
    Document   : education
    Created on : 14-Jun-2016, 12:01:48
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Language | Dimata Hairisma</title>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <br><button onfocus="test" type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showlangform" data-command="0"> Add Language</button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/language_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showlangform'){
                        $(".addeditgeneral-title").html("Edit Language");
                        }

                        }else{
                            if(dataFor == 'showlangform'){
                                $(".addeditgeneral-title").html("Add Language");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/language_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
