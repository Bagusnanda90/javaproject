...
<html>
    <head>
        ...
        <title>Master Position group List | Dimata Hairisma</title>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-body">
                            <div class="row">
                                    <div class="col-xs-12">
                                        <strong style="font-size: 20px">Position Group List</strong>
                                          <br/>
                                          <br/>
                                          <div class="col-md-12">
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showposgroupform" data-command="0">Add New Master</button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/positiongroup_ajax.jsp", dataSend, onDone, onSuccess);
			...
			if(dataFor == 'showposgroupform'){
			    $(".addeditgeneral-title").html("Edit Position Group");
                       ...
                       sendData("<%= approot %>/masterdata/ajax/positiongroup_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
