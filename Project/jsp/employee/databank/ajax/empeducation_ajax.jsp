...
<%
    ...
    if(datafor.equals("listeducation")){
        ...
        %>
        <table id="listEducation" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Education</th>
            ...
            <tr>
                ...
                <td><%= empEducation.getEducationDesc()%></td>
                    <td>
                    <button type="button" onclick="location.href='javascript:'" data-oid="<%= empEducation.getOID() %>" data-empId="<%= empEducation.getEmployeeId() %>" class="addeditdataedu btn btn-primary" data-command="<%= Command.NONE %>" data-for="showeducationform"  data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i></button>
                    <button type="button" onclick="location.href='javascript:'" data-oid="<%= empEducation.getOID() %>" data-for="showeducationform" data-command="<%= Command.DELETE %>" class="btn btn-danger deletedataedu"  data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-times"></i></button>
                    </td>
                </tr>
                <%
            }
        ...
        if(iCommand == Command.SAVE){
            ...
            <div class="form-group">
             ...
             <div id="div_input" class="col-sm-7">
