...
<html>
    <head>
        ...
        <title>Schedule Category | Dimata Hairisma</title>
                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showcategoryform">
	...
	$(document).ready(function(){
	    //SET ACTIVE MENU
            ...
            $("#schCategory").addClass("treeview active");
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showcategoryform'){
			    $(".addeditgeneral-title").html("Edit Category");
			}

		    }else{
			if(dataFor == 'showcategoryform'){
			    $(".addeditgeneral-title").html("Add Category");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxScheduleCategory", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxScheduleCategory", null, true, "json");
		...
		dataTablesOptions("#categoryElement", "tablecategoryElement", "AjaxScheduleCategory", "listschcategory", callBackDataTables);
	    }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletedivision", ".<%= FrmScheduleCategory.fieldNames[FrmScheduleCategory.FRM_FIELD_SCHEDULE_CATEGORY_ID]%>");
		...
		if(generaldatafor == "showcategoryform"){
		    divisionForm();
		    onDone = function(data){
			runDataTables();
		    };
