...
public class PstMappingPosition extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static String[] typeOfLink = {
        "none","Supervisory", "Coordination", "Leave Approval", "Schedule Change Form Approval", "EO Form Approval", "Warning"
    };
     ...
     * @return
     */
 public static Vector getWarningEmployeeTopLink(long employeeId, int typeOfLink) {
