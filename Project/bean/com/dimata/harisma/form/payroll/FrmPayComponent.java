...
public class FrmPayComponent extends FRMHandler implements I_FRMInterface, I_FRMType {
	...
	public static final int FRM_FIELD_COMP_TYPE			=  2 ;
        ...
        public static final int FRM_FIELD_DECIMAL_FORMAT = 15;
        public static final int FRM_FIELD_SHOW_IN_LOS_REPORTS = 16;
	...
	"FRM_FIELD_COMP_TYPE",
        ...
        "TAX_RPT_GROUP",
        "FRM_FIELD_DECIMAL_FORMAT",
        "FRM_FIELD_SHOW_IN_LOS_REPORTS"
       };
     ...
     public void requestEntityObject(PayComponent payComponent) {
		try{
			this.requestParam();
                        ...
                        /* Update by Hendra Putu | 2016-04-12 */
                        payComponent.setDecimalFormat(getInt(FRM_FIELD_DECIMAL_FORMAT));
                        payComponent.setShowinlosreports(getInt(FRM_FIELD_SHOW_IN_LOS_REPORTS));
               	}catch(Exception e){
