...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_PAYROLL, AppObjInfo.G2_PAYROLL_PROCESS, AppObjInfo.OBJ_PAYROLL_PAYSLIP_GROUP);%>
            ...
            <div class="tablecolor">
                <form name="frmpayslipgroup" method ="post" action="">
                    ...
                    if (listCompany != null && listCompany.size()>0){
                        %><%= drawList(listCompany, oidPayslipGroup, privUpdate)%><%
                    } else {    
                    %> No Data <%
                    }
                    %>
