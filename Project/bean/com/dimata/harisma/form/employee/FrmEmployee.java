...
public class FrmEmployee extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_EMP_DOC_ID = 89;//add by priska 20151104
    public static final int FRM_FIELD_HISTORY_GROUP = 90;//add by priska 20151104
    public static final int FRM_FIELD_HISTORY_TYPE = 91;//add by priska 20151104
    public static final int FRM_FIELD_EMP_DOC_ID_GRADE = 92;//add by priska 20151104
    
    public static final int FRM_FIELD_BIRTH_DATE_STRING = 93;
    public static final int FRM_FIELD_COMMENCING_DATE_STRING = 94;
    public static final int FRM_FIELD_PROBATION_END_DATE_STRING = 95;
    public static final int FRM_FIELD_SECONDARY_ID_TYPE = 96;
    public static final int FRM_FIELD_SECONDARY_ID_NO = 97;
    public static final int FRM_FIELD_SECONDARY_ID_DATE = 98;
    public static final int FRM_FIELD_INDENT_CARD_VALID_TO_STRING = 99;
    public static final int FRM_FIELD_SECONDARY_ID_DATE_STRING = 100;
    public static final int FRM_FIELD_BPJS_DATE_STRING = 101;
    public static final int FRM_FIELD_ASTEK_DATE_STRING = 102;
    public static final int FRM_FIELD_END_CONTRACT_STRING = 103;
    public static final int FRM_FIELD_START_DATE_PENSIUN_STRING = 104;
    public static final int FRM_FIELD_WA_FROM = 105;
    public static final int FRM_FIELD_WA_FROM_STRING = 106;
    public static final int FRM_FIELD_WA_TO = 107;
    public static final int FRM_FIELD_WA_TO_STRING = 108;
    public static final int FRM_FIELD_RESIGNED_DATE_STRING = 109;
    public static final int FRM_FIELD_SUB_SECTION_ID = 110;
    public static final int FRM_FIELD_WA_SUB_SECTION_ID = 111;
    public static final int FRM_FIELD_ACKNOWLEDGE_STATUS = 112;
    public static final int FRM_FIELD_FINGER_CHECK = 113;
    ...
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_EMP_DOC_ID_GRADE",
        "FRM_FIELD_BIRTH_DATE_STRING",
        "FRM_FIELD_COMMENCING_DATE_STRING",
        "FRM_FIELD_PROBATION_END_DATE_STRING",
        "FRM_FIELD_SECONDARY_ID_TYPE",
        "FRM_FIELD_SECONDARY_ID_NO",
        "FRM_FIELD_SECONDARY_ID_DATE",
        "FRM_FIELD_INDENT_CARD_VALID_TO_STRING",
        "FRM_FIELD_SECONDARY_ID_DATE_STRING",
        "FRM_FIELD_BPJS_DATE_STRING",
        "FRM_FIELD_ASTEK_DATE_STRING",
        "FRM_FIELD_END_CONTRACT_STRING",
        "FRM_FIELD_START_DATE_PENSIUN_STRING",
        "FRM_FIELD_WA_FROM",
        "FRM_FIELD_WA_FROM_STRING",
        "FRM_FIELD_WA_TO",
        "FRM_FIELD_WA_TO_STRING",
        "FRM_FIELD_RESIGNED_DATE_STRING",
        "FRM_FIELD_SUB_SECTION_ID",
        "FRM_FIELD_WA_SUB_SECTION_ID",
    ...
    public void requestEntityObject(Employee employee) {
        try {
            ...
            String birthDateString = getString(FRM_FIELD_BIRTH_DATE_STRING);
            
            ////
            if (birthDateString.length() > 0){
                employee.setBirthDate(format.parse(birthDateString));
            } else {
            ...
            String astekDate= getString(FRM_FIELD_ASTEK_DATE_STRING);
            if (astekDate.length() > 0){
                employee.setAstekDate(format.parse(astekDate));
            } else {
                employee.setAstekDate(getDate(FRM_FIELD_ASTEK_DATE));
            }
            ...
            String commencingDateString = getString(FRM_FIELD_COMMENCING_DATE_STRING);
            if (commencingDateString.length() > 0){
                employee.setCommencingDate(format.parse(commencingDateString));
            } else {
                employee.setCommencingDate(getDate(FRM_FIELD_COMMENCING_DATE));
            }
            ...
            String resignedDateString = getString(FRM_FIELD_RESIGNED_DATE_STRING);
            if (resignedDateString.length() > 0){
                employee.setResignedDate(format.parse(resignedDateString));
            } else {
            ...
            String indentCardNR = getString(FRM_FIELD_INDENT_CARD_VALID_TO_STRING);
            if (indentCardNR.length() > 0){
                employee.setIndentCardValidTo(format.parse(indentCardNR));
            } else {
            ...
            String endContract = getString(FRM_FIELD_END_CONTRACT_STRING);
            if (endContract.length() > 0){
                employee.setEnd_contract(format.parse(endContract));
            } else {
            ...
            String bpjsDate= getString(FRM_FIELD_BPJS_DATE_STRING);
            if (bpjsDate.length() > 0){
                employee.setBpjs_date(format.parse(bpjsDate));
            } else {
            ...
            String probationEndDateDateString = getString(FRM_FIELD_PROBATION_END_DATE_STRING);
            if (probationEndDateDateString.length() > 0){
                employee.setProbationEndDate(format.parse(probationEndDateDateString));
            } else {
            ...
            String datePensiun = getString(FRM_FIELD_START_DATE_PENSIUN_STRING);
            if (datePensiun.length() > 0){
                employee.setStartDatePensiun(format.parse(datePensiun));
            } else {
            ...
            employee.setEmpDocId(getLong(FRM_FIELD_EMP_DOC_ID));
            employee.setHistoryGroup(getInt(FRM_FIELD_HISTORY_GROUP));
            employee.setHistoryType(getInt(FRM_FIELD_HISTORY_TYPE));
            employee.setEmpDocIdGrade(getLong(FRM_FIELD_EMP_DOC_ID_GRADE));
            employee.setSecondaryIdType(getString(FRM_FIELD_SECONDARY_ID_TYPE));
            employee.setSecondaryIdNo(getString(FRM_FIELD_SECONDARY_ID_NO));
            employee.setSubSectionId(getLong(FRM_FIELD_SUB_SECTION_ID));
            employee.setWaSubSectionId(getLong(FRM_FIELD_WA_SUB_SECTION_ID));
            
            String secondaryIdDate = getString(FRM_FIELD_SECONDARY_ID_DATE_STRING);
            if (secondaryIdDate.length() > 0){
                employee.setSecondaryIDValid(format.parse(secondaryIdDate));
            } else {
                employee.setSecondaryIDValid(getDate(FRM_FIELD_SECONDARY_ID_DATE));
            }
            
            String waFrom = getString(FRM_FIELD_WA_FROM_STRING);
            if (waFrom.length() > 0){
                employee.setWaFrom(format.parse(waFrom));
            } else {
                employee.setWaFrom(getDate(FRM_FIELD_WA_FROM));
            }
            
            String waTo = getString(FRM_FIELD_WA_TO_STRING);
            if (waTo.length() > 0){
                employee.setWaTo(format.parse(waTo));
            } else {
                employee.setWaTo(getDate(FRM_FIELD_WA_TO));
            }
            ...
            Date caritahun = format.parse(birthDateString);
            String shio = "";
            String S_elemen = "";
            ...
            employee.setAcknowledgeStatus(getInt(FRM_FIELD_ACKNOWLEDGE_STATUS));
            employee.setFingerCheck(getInt(FRM_FIELD_FINGER_CHECK));
