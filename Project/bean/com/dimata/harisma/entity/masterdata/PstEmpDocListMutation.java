...
public class PstEmpDocListMutation extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language { 
   ...
   public static final int FLD_WORK_FROM = 11;
   public static final int FLD_GRADE_LEVEL_ID = 12;
   public static final int FLD_HISTORY_TYPE = 13;
   public static final int FLD_HISTORY_GROUP = 14;
   public static final int FLD_WORK_TO = 15;
   public static final int FLD_TIPE_DOC = 16;
   public static final int FLD_RESIGN_REASON = 17;
   public static final int FLD_RESIGN_DESC = 18;
   public static final int FLD_EMP_NUM = 19;
   public static final int FLD_CONTRACT_FROM = 20;
   public static final int FLD_CONTRACT_TO = 21;
    ...
    public static int MUTASIDANPROMOSI = 0;
    public static int PENGANGKATAN = 1;
    public static int RESIGN = 2;
    /* add by Hendra Putu 20160530 */
    public static int PENERIMAAN = 3;
    public static int PERPANJANGAN_KONTRAK = 4;
    //ganki priska 2016
    public static int SALARY_COMPONENT = 5;
    public static String[] tipeDoc = {"Mutasi Dan Promosi", "Pengangkatan", "Resign", "Penerimaan", "Perpanjangan Kontrak", "Salary Component"};
	...
	public static EmpDocListMutation fetchExc(long oid) throws DBException{ 
		try{ 
                            ...
                            empDocListMutation.setGradeLevelId(pstEmpDocListMutation.getLong(FLD_GRADE_LEVEL_ID));
                            empDocListMutation.setHistoryType(pstEmpDocListMutation.getInt(FLD_HISTORY_TYPE));
                            empDocListMutation.setHistoryGroup(pstEmpDocListMutation.getInt(FLD_HISTORY_GROUP));
                            empDocListMutation.setWorkTo(pstEmpDocListMutation.getDate(FLD_WORK_TO));
                            empDocListMutation.setTipeDoc(pstEmpDocListMutation.getInt(FLD_TIPE_DOC));
                            empDocListMutation.setResignReason(pstEmpDocListMutation.getInt(FLD_RESIGN_REASON));
                            empDocListMutation.setResignDesc(pstEmpDocListMutation.getString(FLD_RESIGN_DESC));
                            empDocListMutation.setEmpNum(pstEmpDocListMutation.getString(FLD_EMP_NUM));
                            empDocListMutation.setContractFrom(pstEmpDocListMutation.getDate(FLD_CONTRACT_FROM));
                            empDocListMutation.setContractTo(pstEmpDocListMutation.getDate(FLD_CONTRACT_TO));
	...
	public static long insertExc(EmpDocListMutation empDocListMutation) throws DBException{ 
		try{ 
            ...
            pstEmpDocListMutation.setLong(FLD_GRADE_LEVEL_ID, empDocListMutation.getGradeLevelId());
            pstEmpDocListMutation.setLong(FLD_HISTORY_TYPE, empDocListMutation.getHistoryType());
            pstEmpDocListMutation.setLong(FLD_HISTORY_GROUP, empDocListMutation.getHistoryGroup());
            pstEmpDocListMutation.setDate(FLD_WORK_TO, empDocListMutation.getWorkTo());
            pstEmpDocListMutation.setInt(FLD_TIPE_DOC, empDocListMutation.getTipeDoc());
            pstEmpDocListMutation.setInt(FLD_RESIGN_REASON, empDocListMutation.getResignReason());
            pstEmpDocListMutation.setString(FLD_RESIGN_DESC, empDocListMutation.getResignDesc());
            pstEmpDocListMutation.setString(FLD_EMP_NUM, empDocListMutation.getEmpNum());
            pstEmpDocListMutation.setDate(FLD_CONTRACT_FROM, empDocListMutation.getContractFrom());
            pstEmpDocListMutation.setDate(FLD_CONTRACT_TO, empDocListMutation.getContractTo());            
	...
	private static void resultToObject(ResultSet rs, EmpDocListMutation empDocListMutation){
		try{
			empDocListMutation.setOID(rs.getLong(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_EMP_DOC_LIST_MUTATION_ID]));
                        ...
                        empDocListMutation.setGradeLevelId(rs.getLong(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_GRADE_LEVEL_ID]));
                        empDocListMutation.setHistoryType(rs.getInt(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_HISTORY_TYPE]));
                        empDocListMutation.setHistoryGroup(rs.getInt(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_HISTORY_GROUP]));
                        empDocListMutation.setWorkTo(rs.getDate(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_WORK_TO]));
                        empDocListMutation.setTipeDoc(rs.getInt(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_TIPE_DOC]));
                        empDocListMutation.setResignReason(rs.getInt(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_RESIGN_REASON]));
                        empDocListMutation.setResignDesc(rs.getString(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_RESIGN_DESC]));
                        empDocListMutation.setEmpNum(rs.getString(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_EMP_NUM]));
                        empDocListMutation.setContractFrom(rs.getDate(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_CONTRACT_FROM]));
                        empDocListMutation.setContractTo(rs.getDate(PstEmpDocListMutation.fieldNames[PstEmpDocListMutation.FLD_CONTRACT_TO]));                        
               }catch(Exception e){ }
	}
    ...
    public static String getNewPosition(long empDocId, long empId, String ObjectName) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                try {
                    company = PstCompany.fetchExc(empDocListMutation.getCompanyId());
                } catch (Exception e) {
                }

                Division division = new Division();
                try {
                    division = PstDivision.fetchExc(empDocListMutation.getDivisionId());
                } catch (Exception e) {
                }

                Department department = new Department();
                try {
                    department = PstDepartment.fetchExc(empDocListMutation.getDepartmentId());
                } catch (Exception e) {
                }

                Section section = new Section();
                try {
                    section = PstSection.fetchExc(empDocListMutation.getSectionId());
                } catch (Exception e) {
                }

                Position position = new Position();
                try {
                    position = PstPosition.fetchExc(empDocListMutation.getPositionId());
                } catch (Exception e) {
                }
    ...
    public static Vector getNewPositionVersi1(long empDocId, long empId, String ObjectName) {
        DBResultSet dbrs = null;
        ...
        try {
            ...
            while (rs.next()) {
                EmpDocListMutation empDocListMutation = new EmpDocListMutation();
                resultToObject(rs, empDocListMutation);
                long[] dataChanged = new long[10];
                dataChanged[0] = empDocListMutation.getCompanyId();
                dataChanged[1] = empDocListMutation.getDivisionId();
                dataChanged[2] = empDocListMutation.getDepartmentId();
                dataChanged[3] = empDocListMutation.getSectionId();
                dataChanged[4] = empDocListMutation.getPositionId();
                dataChanged[5] = empDocListMutation.getLevelId();
                dataChanged[6] = empDocListMutation.getEmpCatId();
                dataChanged[7] = empDocListMutation.getGradeLevelId();
                dataChanged[8] = empDocListMutation.getHistoryGroup();
                dataChanged[9] = empDocListMutation.getHistoryType();
                output.add(dataChanged);
            }
            ...
            DBResultSet.close(dbrs);
                ...
                public static String getNewGradeLevel(long empDocId, long empId, String ObjectName){
		DBResultSet dbrs = null;
		try {
			String sql = "SELECT * FROM " + TBL_EMP_DOC_LIST_MUTATION;
			...
			while(rs.next()) { 
                            ...
                            try{gradeLevel = PstGradeLevel.fetchExc(empDocListMutation.getGradeLevelId());}catch (Exception e){}
                            
                            
                        
                            
                            count = ""+gradeLevel.getCodeLevel(); 
                        }
			...
			DBResultSet.close(dbrs);
                ...
                public static String getNewHistoryType(long empDocId, long empId, String ObjectName){
		DBResultSet dbrs = null;
		try {
			String sql = "SELECT * FROM " + TBL_EMP_DOC_LIST_MUTATION;
			...
			while(rs.next()) { 
                            EmpDocListMutation empDocListMutation = new EmpDocListMutation();
                            resultToObject(rs, empDocListMutation);
                            try{  count = ""+PstCareerPath.historyType[empDocListMutation.getHistoryType()];}catch (Exception e){}
    ...
    public static Hashtable fetchExcHashtable(long oid) throws DBException {
        try {
            Hashtable empMutation = new Hashtable();
            EmpDocListMutation empDocListMutation = new EmpDocListMutation();
            PstEmpDocListMutation pstEmpDocListMutation = new PstEmpDocListMutation(oid);
            ...
            try{
                empDoc = PstEmpDoc.fetchExc(pstEmpDocListMutation.getLong(FLD_EMP_DOC_ID));
            } catch (Exception exc){
                
            }
            
            empDocListMutation.setEmployeeId(pstEmpDocListMutation.getLong(FLD_EMPLOYEE_ID));
            try { employee = PstEmployee.fetchExc(empDocListMutation.getEmployeeId()); } catch (Exception exc){}
            empMutation.put(PstCareerPath.fieldNames[PstCareerPath.FLD_EMPLOYEE_ID], employee.getFullName());
            
            Position position = new Position();
            if(pstEmpDocListMutation.getLong(FLD_EMP_DOC_ID) != 0 && empDoc.getDoc_status() == 2){
                empDocListMutation.setPositionId(pstEmpDocListMutation.getLong(FLD_POSITION_ID));
                try { position = PstPosition.fetchExc(empDocListMutation.getPositionId()); } catch (Exception exc){}
                empMutation.put("POSITION_HISTORY", position.getPosition());
                
                try { position = PstPosition.fetchExc(employee.getPositionId());} catch(Exception exc){}
                empMutation.put("POSITION_NOW", position.getPosition());
            ...
            empMutation.put(PstCareerPath.fieldNames[PstCareerPath.FLD_DEPARTMENT_ID], department.getDepartment());
