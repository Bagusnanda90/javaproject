<%-- 
    Document   : up_pict_process
    Created on : 11-Jul-2016, 12:14:27
    Author     : Acer
--%>

<%@page import="com.dimata.harisma.session.employee.SessEmployeePicture"%>
<%@page import="com.dimata.harisma.entity.employee.EmpPicture"%>
<%@page import="com.dimata.harisma.entity.employee.PstEmpPicture"%>
				 ...
				 SessEmployeePicture objSessEmployeePicture = new SessEmployeePicture();	
                                Employee employee = new Employee();
                                 try {
                                     ...
                                     employee = PstEmployee.fetchExc(Long.valueOf(oidEmployee));
                                 } catch(Exception esx){
                                     
                                 }
				 String pathFileName = objSessEmployeePicture.getAbsoluteFileName(employee.getEmployeeNum());
...
catch(Exception e) 
{
 ...
 %>
<%
    	response.sendRedirect("up_picture.jsp?command="+Command.EDIT+"&employee_oid="+oidEmployee);
%>
