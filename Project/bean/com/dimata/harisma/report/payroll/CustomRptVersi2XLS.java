 ...
 * @author Dimata 007
 */
public class CustomRptVersi2XLS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        */
        ...
        Vector listResult = PstCustomRptConfig.listDataWithoutPaySlip(strSelect+" FROM hr_employee "+strJoin+" "+whereClause + strOrderBy, listData);
        //======================================================================//
        ...
        */
        ...
        response.setHeader("Content-Disposition","attachment; filename=" + customRptMain.getRptMainTitle().replaceAll(" ", "_") + ".xls");
