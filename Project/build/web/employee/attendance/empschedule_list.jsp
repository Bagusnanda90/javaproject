...
public String drawListSchedule(JspWriter outObj, Vector objectClass, boolean privUpdate)
{	
	Date now = new Date();	
	int monthStartDate = Integer.parseInt(String.valueOf(now.getMonth()));
	int yearStartDate =  Integer.parseInt(String.valueOf(now.getYear()+1900));
                                  ...
                                  <td valign="top"> <!-- #BeginEditable "content" --> 
                                    <form name="frm_empschedule" method="post" action="">  
                                      ...
                                      <table border="0" width="100%">
                                        <tr> 
                                          <td height="8" width="100%" class="listtitle">Working Schedule List</td>
                                        </tr>
                                      </table>
                                      <%
                                      ...
                                      <%//=drawListNew(records)%> 
                                      <%
                                        drawListSchedule(out,records, privUpdate);
                                      %> 
                                      <%}
										else{
										%>
