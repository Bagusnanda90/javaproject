<%-- 
    Document   : warning_view
    Created on : Dec 28, 2015, 11:51:47 AM
    Author     : Dimata 007
--%>
...
<%
    ...
    listWarning = PstEmpWarning.list(0, 0, whereClause, orderClause);
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Databank - <%=dictionaryD.getWord(I_Dictionary.WARNING) %></title>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Databank <strong style="color:#333;"> / </strong><%=dictionaryD.getWord(I_Dictionary.WARNING) %></span>
        </div>
        <% if (oidEmployee != 0) {%>
            <div class="navbar">
                <ul style="margin-left: 97px">
                    ...
                    <li class="active"> <a href="warning_view.jsp" class="tablink"><%=dictionaryD.getWord(I_Dictionary.WARNING) %></a> </li>
        ...
        <div class="content-main">
            <div class="box">
                <div id="box_title">Daftar <%=dictionaryD.getWord(I_Dictionary.WARNING) %></div>
                <div id="box_content">
                    <%
                    if (listWarning != null && listWarning.size()>0){
                        %><%=drawList(listWarning)%><%
                    } else {
