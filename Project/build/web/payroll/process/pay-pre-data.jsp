...
if (iCommand == Command.UPDATE ){
    ...
    if (!CompName.equals("")){
                       ...
                       Vector listEmpLevel = PstPayEmpLevel.listEmpLevelwithDateResign(levelCode, checkValues, oidDivision, oidDepartment, null , PstEmployee.NO_RESIGN, payPeriod123.getStartDate(), payPeriod123.getEndDate(),payPeriod123.getStartDate(), payPeriod123.getEndDate(),0 );
                              ...
                              <table style="border:1px solid <%=garisContent%>" width="100%" cellspacing="1" cellpadding="1"  >
									...
									<input type="hidden" name="statusSave" value="<%=statusSave%>">
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          ...
                                          <td><b class="listtitle"><font size="3" color="#000000">Period &nbsp; &nbsp;</font></b></td>
                                          <td> :
											<%
                                        ...
                                        <tr> 
                                          ...
                                          <td> : <input name="level" type="text" readonly="true" value="<%=levelCode%>"> <a href="javascript:openLevel();">Select</a>
                                          ...
                                          <td>Dept</td> 
                                          <td> : <%  DepartmentIDnNameList keyList= new DepartmentIDnNameList ();          
							   ...
							   dept_value.add("0");
                                        ...
                                        <tr> 
                                          ...
                                          <td nowrap><a href="javascript:cmdSearch()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image10','','<%=approot%>/images/BtnSearchOn.jpg',1)" id="aSearch"><img name="Image10" border="0" src="<%=approot%>/images/BtnSearch.jpg" width="24" height="24" alt="Search Employee"></a>
                                          ...
                                          if (privAdd == true){
                                              %>
                                                ...
                                                <a href="javascript:cmdGenerate()" class="command">     ||   GENERATE</a>
                                              <%
                                          }
                                          %>
