...
// proses calculate            
          if (iCommand == Command.START ) {
                    ...
                    listEmpLevel = PstPayEmpLevel.listEmpLevel(levelCode, levelSel,oidDivision, oidDepartment, payrollGroupId );
                    
                    PayProcessManager payProcessMan =  PayProcessManager.getInstance(periodId, levelCode,oidDivision, oidDepartment, levelSel, payGroupId, payrollGroupId);
