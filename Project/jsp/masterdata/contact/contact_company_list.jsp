<%-- 
    Document   : contact_company_list
    Created on : Aug 15, 2016, 5:37:42 PM
    Author     : ARYS
--%>
...
<html>
    <head>
        ...
        <title>Master Training | Dimata Hairisma</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Training Organizer</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Training Organizer</strong>
                                            <hr />
                                            <div id="listdata">
                                            </div>
                                        </div>
                                ...
                                <div class="box-footer">
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showCform" data-command="0">Add Training Organizer</button>
                                          <!-- Modal -->
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/contact/ajax/contact_company_list_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showCform'){
                        $(".addeditgeneral-title").html("Edit Traning Organizer <br> <font color='red'>* ] Enty Required </font>");
                        }

                        }else{
                            if(dataFor == 'showCform'){
                                $(".addeditgeneral-title").html("Add Traning Organizer <br> <font color='red'>* ] Enty Required </font>");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/contact/ajax/contact_company_list_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
