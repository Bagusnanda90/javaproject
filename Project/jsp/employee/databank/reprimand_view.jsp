<%-- 
    Document   : reprimand_view
    Created on : Dec 28, 2015, 11:56:00 AM
    Author     : Dimata 007
--%>
...
<%
    ...
    Vector listReprimand = PstEmpReprimand.list(0, 0, whereClause, orderClause);
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Databank - <%=dictionaryD.getWord(I_Dictionary.REPRIMAND) %></title>
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Databank <strong style="color:#333;"> / </strong><%=dictionaryD.getWord(I_Dictionary.REPRIMAND) %></span>
        </div>
        <% if (oidEmployee != 0) {%>
            <div class="navbar">
                <ul style="margin-left: 97px">
                    ...
                    <li class="active"> <a href="reprimand_view.jsp" class="tablink"><%=dictionaryD.getWord(I_Dictionary.REPRIMAND) %></a> </li>
        ...
        <div class="content-main">
            <div class="box">
                <div id="box_title">Daftar <%=dictionaryD.getWord(I_Dictionary.REPRIMAND) %></div>
                <div id="box_content">
                    <%
                    if(listReprimand != null && listReprimand.size()>0){
                        %>
                        <%=drawList(listReprimand)%>
                        <%
                    } else {
                        %>
