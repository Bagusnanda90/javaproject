                            ...
                            <table width="100%" border="0">
                                              ...
                                              <%}%>
                                               ...
                                               <tr>
                                                   <td colspan="5">
                                                       <hr>
                                                       <img src="../../images/BtnSearchOn.jpg"  onclick="javascript:openAllSlipDetail('<%=employee.getOID()%>','<%=periodeId%>');"><a href="javascript:openAllSlipDetail('<%=employee.getOID()%>','<%=periodeId%>');" >Open Detail Pay Slip</a>                                                   </td>
                                               </tr>
                                               <tr>
                                                   <td colspan="5">
                                                       <hr>
