                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showdivisionform">
...
<!--                <section class="content">
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxDivision", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxDivision", null, true, "json");
		...
		validateOptions("#<%= FrmDivision.fieldNames[FrmDivision.FRM_FIELD_DIVISION] %>", 'text', 'has-error', 1, null);
		//validateOptions("#<%= FrmDivision.fieldNames[FrmDivision.FRM_FIELD_COMPANY_ID] %>", 'text', 'has-error', 1, null);
	    }
		...
		dataTablesOptions("#divisionElement", "tabledivisionElement", "AjaxDivision", "listdivision", callBackDataTables);
	    }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletedivision", ".<%= FrmDivision.fieldNames[FrmDivision.FRM_FIELD_DIVISION_ID]%>");
		...
		if(generaldatafor == "showdivisionform"){
		    divisionForm();
		    onDone = function(data){
			runDataTables();
		    };
