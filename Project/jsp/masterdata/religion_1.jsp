<%-- 
    Document   : religion
    Created on : 15-Jun-2016, 09:01:45
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Religion | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Religion List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <br><button onfocus="test" type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showreligionform" data-command="0"> Add Religion</button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/religion_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showreligionform'){
                        $(".addeditgeneral-title").html("Edit Religion");
                        }

                        }else{
                            if(dataFor == 'showwarningform'){
                                $(".addeditgeneral-title").html("Add Religion");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/religion_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
