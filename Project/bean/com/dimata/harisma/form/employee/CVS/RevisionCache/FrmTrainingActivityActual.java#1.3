...
public class FrmTrainingActivityActual extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_TRAINING_TITLE = 12;
    public static final int FRM_FIELD_TRAIN_END_DATE = 13;
    ...
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_TRAINING_TITLE", "FRM_FIELD_TRAIN_END_DATE"
    };
    public static int[] fieldTypes = {
        ...
        TYPE_LONG, TYPE_LONG, TYPE_LONG, TYPE_STRING, TYPE_DATE
    };
    ...
    public String getFormName() {
        return FRM_NAME_TRAININGACTIVITYACTUAL;
    }
    ...
    public TrainingActivityActual getEntityObject() {
    ...
    public void requestEntityObject(TrainingActivityActual trainingActivityActual) {
        try {
            ...
            trainingActivityActual.setTrainingTitle(getString(FRM_FIELD_TRAINING_TITLE));
            trainingActivityActual.setTrainEndDate(getDate(FRM_FIELD_TRAIN_END_DATE));
        } catch (Exception e) {
