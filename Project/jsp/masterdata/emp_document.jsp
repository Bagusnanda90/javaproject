                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showdocform" data-command="0"> Add Document</button> 
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       var onDone = function(data){
                           ...
                           addEditTable("#listdoc", ".addeditdata");
                       ...
                       sendData("<%= approot %>/employee/document/emp_doc_ajax.jsp", dataSend, onDone, onSuccess);
			...
			if(dataFor == 'showposform'){
			    $(".addeditgeneral-title").html("Edit Position");
                       ...
                       sendData("<%= approot %>/employee/document/emp_doc_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
                addEdit(".addeditdata");
