...
<html>
    <head>
        ...
        <title>Master Family Relationship | Dimata Hairisma</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        Master Family Relationship
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../../home.jsp"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active">Family Relationship</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Family Relationship List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <br><button onfocus="test" type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showfamRelationform" data-command="0"> Add Family Relation</button>
       ...
       <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/famRelation_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showfamRelationform'){
                        $(".addeditgeneral-title").html("Edit Family Rellation");
                        }

                        }else{
                            if(dataFor == 'showfamRelationform'){
                                $(".addeditgeneral-title").html("Add Family Rellation");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/famRelation_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
