...
<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li>
              <a href="#"><i class="fa fa-users"></i> <span>Databank</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="<%= approot%>/employee/databank/employee_list.jsp"><i class="fa fa-circle-o"></i> Employee Data</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Add New Employee</a></li>
              </ul>
            </li>
