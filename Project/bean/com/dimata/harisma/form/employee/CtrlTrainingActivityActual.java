		...
		switch(cmd){
			...
			case Command.SAVE :
				...
				frmTrainingActivityActual.requestEntityObject(trainingActivityActual);
                                ...
                                Date dateEnd = new Date(FRMQueryString.requestInt(request, "yearEnd"), FRMQueryString.requestInt(request, "monthEnd"), FRMQueryString.requestInt(request, "dateEnd"));
                                trainingActivityActual.setTrainEndDate(dateEnd);
