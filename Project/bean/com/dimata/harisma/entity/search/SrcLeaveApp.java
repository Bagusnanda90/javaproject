...
public class SrcLeaveApp {
    ...
    private boolean draft = true;
     ...
     /** Holds value of property toBeApprove. */
    private boolean toBeApprove = true;

     /** Holds value of property approved. */
    ...
    private int approvalHRMan = -1;
    
    private int approvalGM = -1;
    
    private int typePublicLeave=0;
    ...
    public int getApprovalHRMan() {
        return approvalHRMan;
    }

    public void setApprovalHRMan(int approvalHRMan) {
        this.approvalHRMan = approvalHRMan;
    }

    public Date getTakenLeave() {
        return takenLeave;
    }

    public void setTakenLeave(Date takenLeave) {
        this.takenLeave = takenLeave;
    }

    public int getApprovalGM() {
        return approvalGM;
    }

    public void setApprovalGM(int approvalGM) {
    ...
    public boolean isToBeApprove() {
        return toBeApprove;
    }

    public void setToBeApprove(boolean toBeApprove) {
        this.toBeApprove = toBeApprove;
    }
    ...
    /**
     * @return the typePublicLeave
     */
    public int getTypePublicLeave() {
        return typePublicLeave;
    }

    /**
     * @param typePublicLeave the typePublicLeave to set
     */
    public void setTypePublicLeave(int typePublicLeave) {
        this.typePublicLeave = typePublicLeave;
    }

    /**
     * @return the selectedFrom
     */
    ...
    /**
     * @param selectedFrom the selectedFrom to set
     */
    public void setSelectedFrom(Date selectedFrom) {
     ...
     */
    public void setSelectedTo(Date selectedTo) {
