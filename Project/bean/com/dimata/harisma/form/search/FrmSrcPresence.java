...
public class FrmSrcPresence extends FRMHandler implements I_FRMInterface, I_FRMType 
{
	...
	public static final int FRM_FIELD_DATETO			=  6 ;
        ...
        public static final int FRM_FIELD_DATEFROM_STR                  = 10 ;
        public static final int FRM_FIELD_DATETO_STR                   = 11 ;
	...
	public static String[] fieldNames = {
		...
		"FRM_FIELD_DATETO", "FRM_FIELD_PERIOD_CHECKED", 
                ...
                "FRM_FIELD_DATEFROM_STR", "FRM_FIELD_DATETO_STR"
	} ;
	...
	public void requestEntityObject(SrcPresence srcPresence) {
		try{
			this.requestParam(); 
                        ...
                        String fromDateStr = getString(FRM_FIELD_DATEFROM_STR);
                        String toDateStr = getString(FRM_FIELD_DATETO_STR);
			...
			srcPresence.setDatefrom(fromDateStr.equals("") ? getDate(FRM_FIELD_DATEFROM) : java.sql.Date.valueOf(fromDateStr));
			srcPresence.setDateto(toDateStr.equals("") ? getDate(FRM_FIELD_DATETO) : java.sql.Date.valueOf(toDateStr));  
