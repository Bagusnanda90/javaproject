...
%>
<%!
public String drawList(Vector objectClass, int st,FrmEmpDocList frmObject, long empDocL, String ObjectName){
	...
	ctrlist.addHeader("Job","12%");
	ctrlist.addHeader("Assign AS","12%");
	...
	for (int i = 0; i < objectClass.size(); i++) {
		...
		rowx.add(String.valueOf(st + 1 + i));
                rowx.add("<a href=\"javascript:cmdSaveSingle('"+employee.getOID()+"')\">"+employee.getEmployeeNum()+"</a>");
		...
		rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDocList.FRM_FIELD_JOB_DESC] +i+"\" value=\""+empDocList.getJob_desc()+"\" class=\"elemenForm\"><input type=\"hidden\" name=\""+frmObject.fieldNames[FrmEmpDocList.FRM_FIELD_EMPLOYEE_ID] +i+"\" value=\""+employee.getOID()+"\" class=\"elemenForm\"> <input type=\"hidden\" name=\""+frmObject.fieldNames[FrmEmpDocList.FRM_FIELD_EMP_DOC_ID] +i+"\" value=\""+empDocL+"\" class=\"elemenForm\"><input type=\"hidden\" name=\""+frmObject.fieldNames[FrmEmpDocList.FRM_FIELD_OBJECT_NAME] +i+"\" value=\""+ObjectName+"\" class=\"elemenForm\">");
                //rowx.add("<input type=\"checkbox\" name=\"userSelect\" id=\"userSelect"+ inputName +"\" value=\"" + inputName + "\" >");
                rowx.add("<input type=\"text\" name=\""+frmObject.fieldNames[FrmEmpDocList.FRM_FIELD_ASSIGN_AS] +i+"\" value=\""+empDocList.getAssign_as()+"\" class=\"elemenForm\">");
                    
                //rowx.add(section.getSection());
		
		lstData.add(rowx);
		lstLinkData.add(String.valueOf(employee.getOID()) + "','" + employee.getEmployeeNum() + "','" + employee.getFullName() + "','" + department.getDepartment()+ "','" + employee.getAddress());
	}
	return ctrlist.draw();
}
%>
...
<%
    ...
    long oidEmpDocList = FRMQueryString.requestLong(request,"oidEmpDocList");
...
//    String whereClause = "RESIGNED = 0";
    ...
    String where ="";
           if (empId.length()>0 && empId != null){   where =  " AND EMP." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]+" NOT IN("+empId+") "; }
    where ="";  
      iErrCode = ctrlEmpDocList.action(iCommand , oidEmpDocList,srcEmployee,start,recordToGet,where,objectName,oidEmpDoc, oidEmployee);
    
   Vector listEmployee = new Vector(1,1);
   try{
                
       listEmployee = sessEmployee.searchEmployeeWithDocList(srcEmployee, start, recordToGet,where,objectName,oidEmpDoc);
   }catch(Exception ex){
...
function cmdSave(){
    document.frmEmpDocList.command.value="<%=String.valueOf(Command.SAVE)%>";
    document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
    document.frmEmpDocList.submit();
}    
 function cmdSaveSingle(oidEmployee){
    document.frmEmpDocList.command.value="<%=String.valueOf(Command.POST)%>";
    document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp?oidEmployee="+oidEmployee;
    document.frmEmpDocList.submit();
}       
function cmdEdit(oid, number, fullname, department,address) {
        alert("1");
        //var FRM_FIELD_EMPLOYEE_ID = "FRM_FIELD_EMPLOYEE_ID<%//=value%>";
        //var EMP_FULLNAME = "EMP_FULLNAME<%//=value%>";
        
        //self.opener.document.<%=formName%>.EMP_NUM.value = number;
        //alert("2");
        //self.opener.document.<%=formName%>.<%//=emp_fullname%>.value = fullname;
        //self.opener.document.<%=formName%>.<%//=emp_address%>.value = address;
...
function cmdUpdateDiv(){
    document.frmEmpDocList.command.value="<%=String.valueOf(Command.ADD)%>";
   //document.frmEmpDocList.hidden_goto_div.value = document.frmEmpDocList.<//%//=FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_COMPANY_ID]%>.value;
    document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
    document.frmEmpDocList.submit();
}
function cmdUpdateDep(){
    document.frmEmpDocList.command.value="<%=String.valueOf(Command.ADD)%>";
    ///document.frmEmpDocList.hidden_goto_dept.value = document.frmEmpDocList.<//%=FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_DIVISION_ID]%>.value;
    document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
    document.frmEmpDocList.submit();
}
function cmdUpdatePos(){
    document.frmEmpDocList.command.value="<%=String.valueOf(Command.ADD)%>";
    //document.frmEmpDocList.hidden_goto_sec.value = document.frmEmpDocList.<//%=FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_DEPARTMENT]%>.value;
    document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
    document.frmEmpDocList.submit();
}
//end
function deptChange() {
    document.frmEmpDocList.command.value = "<%=String.valueOf(Command.GOTO)%>";
    document.frmEmpDocList.hidden_goto_dept.value = document.frmEmpDocList.<%=FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_DEPARTMENT]%>.value;
    document.frmEmpDocList.action = "SearchDocumentDetailsSingle.jsp";
    document.frmEmpDocList.submit();
}

function cmdSearch() {
    document.frmEmpDocList.command.value = "<%=String.valueOf(Command.LIST)%>";									
    document.frmEmpDocList.action = "SearchDocumentDetailsSingle.jsp";
    document.frmEmpDocList.submit();
}
...
//-------------- script control line -------------------
		...
		document.frmEmpDocList.command.value="<%=String.valueOf(Command.FIRST)%>";
		document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
		document.frmEmpDocList.submit();
	}

	function cmdListPrev(){
		document.frmEmpDocList.command.value="<%=String.valueOf(Command.PREV)%>";
		document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
		document.frmEmpDocList.submit();
	}

	function cmdListNext(){
		document.frmEmpDocList.command.value="<%=String.valueOf(Command.NEXT)%>";
		document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
		document.frmEmpDocList.submit();
	}

	function cmdListLast(){
		document.frmEmpDocList.command.value="<%=String.valueOf(Command.LAST)%>";
		document.frmEmpDocList.action="SearchDocumentDetailsSingle.jsp";
		document.frmEmpDocList.submit();
	}
                            ...
                            <td valign="top">
		    				  <!-- #BeginEditable "content" -->
                                <% if (privStart) { %>
                                    ...
                                    <input type="hidden" name="oidEmpDocList" value="<%=String.valueOf(oidEmpDocList)%>">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr>
                                            ...
                                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                              <tr> 
                                                <td width="19%"><%=dictionaryD.getWord(I_Dictionary.NAME)%></td>
                                                <td width="1%">:</td>
                                                <td width="80%"> 
                                              ...
                                              <tr> 
                                                <td width="19%"><%=dictionaryD.getWord(I_Dictionary.EMPLOYEE_NUMBER) %></td>
                                                <td width="1%">:</td>
                                                <td width="80%"> 
                                              ...
                                              <tr> 
                                                <td width="19%"><%=dictionaryD.getWord(I_Dictionary.CATEGORY) %></td>
                                                <td width="1%">:</td>
                                                <td width="80%"> 
                                                  <% 
...
Vector sec_value = new Vector(1, 1);
			...
			%>
                        <%= ControlCombo.draw(FrmSrcEmployee.fieldNames[FrmSrcEmployee.FRM_FIELD_SECTION], "formElemen", null, "" + srcEmployee.getSection(), sec_value, sec_key, " onkeydown=\"javascript:fnTrapKD()\"")%></td>
                                              ...
                                              <tr> 
                                                <td width="19%"><%=dictionaryD.getWord(I_Dictionary.POSITION) %></td>
                                                <td width="1%">:</td>
                                                <td width="80%"> 
                                              <% 
      ...
      ||(iCommand==Command.LAST)||(iCommand==Command.LIST))) { %>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <%if((listEmployee!=null)&&(listEmployee.size()>0)){%>
                                                <tr> 
                                                  <td height="8" width="100%"><%=drawList(listEmployee, start,frmEmpDocList,oidEmpDoc ,objectName)%></td>
                                                </tr>
                                                <%}else{%>
                                                <tr> 
