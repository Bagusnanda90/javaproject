<%-- 
    Document   : resignedreason
    Created on : 15-Jun-2016, 09:31:33
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Resigned Reason | Dimata Hairisma</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    <h1>
                        Master Resigned Reason
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="../../home.jsp"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active">Resigned Reason</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Resigned Reason List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showresignedreasonform" data-command="0"> Add Resigned Reason</button>
                                            <!-- Modal -->
                                                  ...
                                                  <div class="modal-dialog">
                                                    <div class="modal-content">
                                                      <div class="modal-header">
                                                        ...
                                                        <h4 class="addeditgeneral-title" id="myModalLabel">Add New Resigned Reason</h4>
                                                      </div>
                                                      <form id="form-modal">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/resignedreason_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showresignedreasonform'){
                        $(".addeditgeneral-title").html("Edit Resigned Reason");
                        }

                        }else{
                            if(dataFor == 'showresignedreasonform'){
                                $(".addeditgeneral-title").html("Add Resigned Reason");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/resignedreason_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
