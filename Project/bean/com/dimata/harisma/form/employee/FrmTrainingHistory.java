...
public class FrmTrainingHistory extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_TRAINING_TITLE = 18;
    public static final int FRM_FIELD_START_TIME_STRING = 19;
    public static final int FRM_FIELD_END_TIME_STRING = 20;    
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_TRAINING_TITLE",
        "FRM_FIELD_START_TIME_STRING",
        "FRM_FIELD_END_TIME_STRING"
    };
    ...
    public void requestEntityObject(TrainingHistory entTrainingHistory) {
        try {
            ...
            String startTime= getString(FRM_FIELD_START_TIME_STRING);
            if (startTime.length() > 0){
                ...
                dt = Validator.composeTime(hour, min, sec);
                entTrainingHistory.setStartTime(dt);
            } else {
                entTrainingHistory.setStartTime(getDate(FRM_FIELD_START_TIME));
            }
            
            String endTime= getString(FRM_FIELD_END_TIME_STRING);
            if (endTime.length() > 0){
                ...
                java.util.Date dt = null;
                dt = Validator.composeTime(hour, min, sec);
                entTrainingHistory.setEndTime(dt);
            } else {
            ...
            entTrainingHistory.setTrainingTitle(getString(FRM_FIELD_TRAINING_TITLE));
        } catch (Exception e) {
