...
//        String ccAddress = (String)session.getValue("ccAddress");
//        String bccAddress = (String)session.getValue("bccAddress");
//        String subject = (String)session.getValue("subject");
//        String message = (String)session.getValue("message");
        String emailAddress = FRMQueryString.requestString(request, "email");
        String [] ccAddress = FRMQueryString.requestStringValues(request, "ccEmail");
        String [] bccAddress = FRMQueryString.requestStringValues(request, "bccEmail");
          ...
          tmpx=tmpx+1;
                            ...
                            if (ccAddress != null){
                                for (int i=0; i < ccAddress.length; i++){
                                    listCc.add(""+ ccAddress[i]);
                                }
                            }

                            if (bccAddress != null){
                                for (int x=0; x < bccAddress.length; x++){
                                    listBcc.add(""+ bccAddress[x]);
                                }
                            }
                            
                            if (ccAddress != null && bccAddress != null){
                                email.sendEmail(listRec, listCc, listBcc, subject, message, attachment, attachmentName);
                            } else if (ccAddress != null && bccAddress == null){
