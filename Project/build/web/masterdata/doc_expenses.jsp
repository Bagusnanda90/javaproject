            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Doc Expenses</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Doc Expenses List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showdocexform" data-command="0">Add Doc Type</button>
                                          <!-- Modal -->
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/doc_expenses_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showdocexform'){
                        $(".addeditgeneral-title").html("Edit Doc Expenses");
                        }

                        }else{
                            if(dataFor == 'showdocexform'){
                                $(".addeditgeneral-title").html("Add Doc Expenses");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/doc_expenses_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
