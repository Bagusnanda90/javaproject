    ...
    switch(indexApproval){
        case 1: 
            %>
                ...
                <jsp:param name="FRM_FLD_APPROVAL_1" value="<%=oidApprover%>" />
        ...
        case 2: 
            %>
                ...
                <jsp:param name="FRM_FLD_LEAVE_APPLICATION_ID" value="<%=oidLeave%>" />
                <jsp:param name="oid_employee" value="<%=oidEmployee%>" />
                <jsp:param name="FRM_FLD_APPROVAL_2" value="<%=oidApprover%>" />
        ...
        case 3: 
            %>
                ...
                <jsp:param name="FRM_FLD_LEAVE_APPLICATION_ID" value="<%=oidLeave%>" />
                <jsp:param name="oid_employee" value="<%=oidEmployee%>" />
                <jsp:param name="FRM_FLD_APPROVAL_3" value="<%=oidApprover%>" />
        ...
        case 4: 
            %>
                ...
                <jsp:param name="FRM_FLD_LEAVE_APPLICATION_ID" value="<%=oidLeave%>" />
                <jsp:param name="oid_employee" value="<%=oidEmployee%>" />
                <jsp:param name="FRM_FLD_APPROVAL_4" value="<%=oidApprover%>" />
        ...
        case 5: 
            %>
                ...
                <jsp:param name="FRM_FLD_LEAVE_APPLICATION_ID" value="<%=oidLeave%>" />
                <jsp:param name="oid_employee" value="<%=oidEmployee%>" />
                <jsp:param name="FRM_FLD_APPROVAL_5" value="<%=oidApprover%>" />
         ...
         case 6: 
            %>
                ...
                <jsp:param name="FRM_FLD_LEAVE_APPLICATION_ID" value="<%=oidLeave%>" />
                <jsp:param name="oid_employee" value="<%=oidEmployee%>" />
                <jsp:param name="FRM_FLD_APPROVAL_6" value="<%=oidApprover%>" />
