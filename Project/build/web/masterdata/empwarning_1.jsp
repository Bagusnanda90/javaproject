<%-- 
    Document   : empwarning
    Created on : 14-Jun-2016, 15:29:58
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Warning | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Warning List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <br><button onfocus="test" type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showwarningform" data-command="0"> Add Warning</button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/empwarning_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/empwarning_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
