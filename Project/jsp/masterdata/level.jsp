...
<html>
                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showLevelForm">
                                    <i class="fa fa-plus"></i> Add Level
                                </button>
                                <button class="btn btn-danger btndeletegeneral" data-for="level">
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
                        $(".addeditgeneral-title").html("Edit Level");
		    }else{
                        $(".addeditgeneral-title").html("Add Level");
		    }                    
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxLevel", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxLevel", null, true, "json");
	    ...
	    //FORM HANDLER
	    var levelForm = function(){
		validateOptions("#<%= FrmLevel.fieldNames[FrmLevel.FRM_FIELD_LEVEL] %>", 'text', 'has-error', 1, null);
	    }
	    ...
	    function runDataTables(dataFor){
                dataTablesOptions("#levelElement", "tableLevelElement", "AjaxLevel", "listLevel", callBackDataTables);
            }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletegeneral", ".<%= FrmLevel.fieldNames[FrmLevel.FRM_FIELD_LEVEL_ID]%>");
