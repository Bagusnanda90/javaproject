...
function cmdGenerateDPAll(){
	document.frmholiday.command.value="<%=Command.APPROVE%>";
	document.frmholiday.prev_command.value="<%=prevCommand%>";
	document.frmholiday.action="publicHoliday.jsp";
	document.frmholiday.submit();
	}    
                                            ...
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                              <tr align="left" valign="top"> 
                                                ...
                                                %>
                                                 ...
                                                 <button id="btn1" onclick="cmdGenerateDP()"  >GENERATE DP</button><button id="btn1" onclick="cmdGenerateDPAll()" >GENERATE DP FOR ALL</button></td>
                                              </tr>
                                              <%
                                try{
