 ...
 * @author GUSWIK
 */
public class LeaveConfigBpd implements I_Leave{
        ...
        try {
            ...
            String sql = " SELECT DISTINCT(HLA."+ PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] +" ) FROM "+
                       ...
                       // " AND HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " BETWEEN "+payPeriod.getPaySlipDate().getYear()+"-01-01 00:00:00 AND "+payPeriod.getPaySlipDate().getYear()+"-12-31 23:59:59 " ;
                        " AND HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " BETWEEN \"" + Formater.formatDate(payPeriod.getEndDate(), "yyyy-01-01 00:00:00") + "\" AND \"" + Formater.formatDate(payPeriod.getEndDate(), "yyyy-12-31 23:59:59") + "\" " +
    ...
    public boolean LLallowanceStatus(LlStockTaken llStockTaken,long periodeId, long employeeId){
        ...
        try {
            ...
            String sql =" SELECT * FROM "+
                        ...
                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = " + employeeId +
                        //" AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " = 3 " +
                        " AND HAST." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE] + " BETWEEN \"" + Formater.formatDate(payPeriod.getEndDate(), "yyyy-01-01 00:00:00") + "\" AND \"" + Formater.formatDate(payPeriod.getEndDate(), "yyyy-12-31 23:59:59") + "\" " ;
//        
            System.out.println("SQL Mencari Al Allowance :::::: " + sql);
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
