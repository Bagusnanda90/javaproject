...
<html>
    <head>
        ...
        <title>Master Data - <%=dictionaryD.getWord(I_Dictionary.POSITION)%></title>
        ...
        <script type="text/javascript">
            ...
            function loadList() {
                ...
                xmlhttp.open("GET", "position-ajax.jsp?position_name=0&valid_status_select=0&level_select=0&division_select=0", true);
                xmlhttp.send();
            }
            ...
            function cmdListFirst(start){                
                ...
                xmlhttp.open("GET", "position-ajax.jsp?position_name=0&command=" + <%=Command.FIRST%> + "&start="+start, true);
                xmlhttp.send();
            }
            ...
            function cmdListPrev(start){
                ...
                xmlhttp.open("GET", "position-ajax.jsp?position_name=0&command=" + <%=Command.PREV%> + "&start="+start, true);
                xmlhttp.send();
            }
            ...
            function cmdListNext(start){
                ...
                xmlhttp.open("GET", "position-ajax.jsp?position_name=0&command=" + <%=Command.NEXT%> + "&start="+start, true);
                xmlhttp.send();
            }
            ...
            function cmdListLast(start){
                ...
                xmlhttp.open("GET", "position-ajax.jsp?position_name=0&command=" + <%=Command.LAST%> + "&start="+start, true);
                xmlhttp.send();
            }
        </script>
        ...
        <div class="content-main">
            <form name="frmposition" method ="post" action="">
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" style="padding:5px 7px" id="position_name" name="position_name" onkeyup="loadListByPosition(this.value)" placeholder="Searching..." size="70" /> </td>
                        <td>
                            <select id="valid_status_select" name="valid_status_select" style="padding:4px 6px" onchange="loadListByValidStatus(this.value)">
                                <option value="0">-SELECT-</option>
                                <option value="<%=PstPosition.VALID_ACTIVE%>"><%= PstPosition.validStatusValue[PstPosition.VALID_ACTIVE] %></option>
                                <option value="<%=PstPosition.VALID_HISTORY%>"><%= PstPosition.validStatusValue[PstPosition.VALID_HISTORY] %></option>
                            </select>
                        </td>
                        <td>
                            <select id="level_select" name="level_select" style="padding:4px 6px" onchange="loadListByLevel(this.value)">
                                <option value="0">-SELECT-</option>
                                <%
                        ...
                        <td>
                            <select id="division_select" name="division_select" style="padding:4px 6px" onchange="loadListByDivision(this.value)">
                                <option value="0">-SELECT-</option>
                                <%
