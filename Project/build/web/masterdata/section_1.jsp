...
<html>
    <head>
        ...
        <title>Section List | Dimata Hairisma</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
                                        ...
                                        <div class="col-md-12">
                                         ...
                                         <div class="box-footer">
                                           <div class="row pull-left">
                                            <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showsecform" data-command="0"> Add Section</button> 
        ...
        <script src="<%= approot %>/assets/plugins/datatables/jquery.dataTables.js"></script>
        <script src="<%= approot %>/assets/plugins/datatables/dataTables.bootstrap.js"></script>
        <script>
            $(function () {
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/section_ajax.jsp", dataSend, onDone, onSuccess);
			...
			if(dataFor == 'showsecform'){
			    $(".addeditgeneral-title").html("Edit Section");
                       ...
                       sendData("<%= approot %>/masterdata/ajax/section_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
