...
<html>
    <head>
        ...
        <title>Department List | Dimata Hairisma</title>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showdeptform" data-command="0"> Add Department</button> 
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/department_ajax.jsp", dataSend, onDone, onSuccess);
			...
			if(dataFor == 'showdeptform'){
			    $(".addeditgeneral-title").html("Edit Department");
                       ...
                       sendData("<%= approot %>/masterdata/ajax/department_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
