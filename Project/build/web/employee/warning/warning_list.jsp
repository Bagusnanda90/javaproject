...
<%!
	...
	if(objectList!=null && objectList.size()>0) {
            ...
            ctrlist.addHeader(listTitles[0],"1%");   
            ctrlist.addHeader(listTitles[1],"5%");
            ...
            ctrlist.addHeader(listTitles[6],"12%");
            ctrlist.addHeader(listTitles[7],"8%"); 
            ctrlist.addHeader(listTitles[8],"15%");    
            ctrlist.addHeader(listTitles[9],"12%"); 
            ...
            for(int i=0; i<objectList.size(); i++) {                
                ...
                Division div = (Division)list.get(2);
                            ...
                            <td valign="top"> 
                                  <!-- #BeginEditable "content" --> 
                                    <form name="frm_warning" method="post" action="">
                                      ...
                                      <input type="hidden" name="start_list" value="<%=start%>">
                                      ...
                                      <table border="0" width="100%">
                                        ...
                                        <tr> 
                                          <td height="8" width="100%"><%=drawList(listWarning, listTitles, start)%></td>
                                        </tr>                                        
                                      </table>                                                                                                                                                                                              
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <%
