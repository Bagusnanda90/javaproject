                        ...
                        <div class="col-md-6" style="border-right: 1px solid black">
                            <div class="pull-left">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox">
                                        Nunc viverra imperdiet enim. Fusce est. Vivamus a tellus. Nunc viverra imperdiet enim. Fusce est. Vivamus a tellus.
                                    </label>
                                </div>
                                <div class="col-md-4 pull-right">
                                    <button type="submit" class="btn btn-primary btn-block btn-flat">Read</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="pull-left">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox">
                                        Nunc viverra imperdiet enim. Fusce est. Vivamus a tellus. Nunc viverra imperdiet enim. Fusce est.
                                    </label>
                                </div>
                                <div class="checkbox">
                                    <label>
                                ...
                                <div class="box-body">
                                    <div class="col-sm-3">
                                        <div class="text-center">
                                            <a id="masterdata_icon" href="<%= approot%>/employee/databank/employee_edit.jsp">
