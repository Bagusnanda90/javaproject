...
public class PstEmployee extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_EMP_DOC_ID = 91;
    public static final int FLD_HISTORY_GROUP = 92;
    public static final int FLD_HISTORY_TYPE = 93;
    public static final int FLD_EMP_DOC_ID_GRADE = 94;
    public static final int FLD_SECONDARY_ID_TYPE = 95;
    public static final int FLD_SECONDARY_ID_NO = 96;
    public static final int FLD_SECONDARY_ID_VALID = 97;
    public static final int FLD_WA_FROM = 98;
    public static final int FLD_WA_TO = 99;
    public static final int FLD_SUB_SECTION_ID = 100;
    public static final int FLD_WA_SUB_SECTION_ID = 101;
    public static final int FLD_ACKNOWLEDGE_STATUS = 102;
    public static final int FLD_FINGER_CHECK = 103;
    ...
    public static Employee fetchExc(long oid) throws DBException {
        try {
            ...
            employee.setEmpDocId(pstEmployee.getLong(FLD_EMP_DOC_ID));
            employee.setHistoryGroup(pstEmployee.getInt(FLD_HISTORY_GROUP));
            employee.setHistoryType(pstEmployee.getInt(FLD_HISTORY_TYPE));
            employee.setEmpDocIdGrade(pstEmployee.getLong(FLD_EMP_DOC_ID_GRADE));
            employee.setSecondaryIdType(pstEmployee.getString(FLD_SECONDARY_ID_TYPE));
            employee.setSecondaryIdNo(pstEmployee.getString(FLD_SECONDARY_ID_NO));
            employee.setSecondaryIDValid(pstEmployee.getDate(FLD_SECONDARY_ID_VALID));
            employee.setWaFrom(pstEmployee.getDate(FLD_WA_FROM));
            employee.setWaTo(pstEmployee.getDate(FLD_WA_TO));
            employee.setSubSectionId(pstEmployee.getLong(FLD_SUB_SECTION_ID));
            employee.setWaSubSectionId(pstEmployee.getLong(FLD_WA_SUB_SECTION_ID));
            employee.setAcknowledgeStatus(pstEmployee.getInt(FLD_ACKNOWLEDGE_STATUS));
            employee.setFingerCheck(pstEmployee.getInt(FLD_FINGER_CHECK));
    ...
    public static Hashtable fetchExcHashtable(long oid) throws DBException {
        ...
        try {
            ...
            try { department = PstDepartment.fetchExc(employee.getDepartmentId()); } catch (Exception e){ }
            ...
            try { position = PstPosition.fetchExc(employee.getPositionId()); } catch (Exception e){ }
            hashtableEmp.put(PstEmployee.fieldNames[PstEmployee.FLD_POSITION_ID], position.getPosition());
            
            employee.setSectionId(pstEmployee.getlong(FLD_SECTION_ID));
            Section section = new Section();
            try { section = PstSection.fetchExc(employee.getSectionId()); } catch (Exception e){ }
            ...
            try { empCategory = PstEmpCategory.fetchExc(employee.getEmpCategoryId()); } catch (Exception e){ }
            hashtableEmp.put(PstEmployee.fieldNames[PstEmployee.FLD_EMP_CATEGORY_ID], empCategory.getEmpCategory());
            
            employee.setLevelId(pstEmployee.getlong(FLD_LEVEL_ID));
            Level level = new Level();
            try { level = PstLevel.fetchExc(employee.getLevelId()); } catch (Exception e){ }
            ...
            try { division = PstDivision.fetchExc(employee.getDivisionId()); } catch (Exception e){ }
            ...
            try { company = PstCompany.fetchExc(employee.getCompanyId()); } catch (Exception e){ }
            ...
            try {  gradeLevel = PstGradeLevel.fetchExc(employee.getGradeLevelId()); } catch (Exception e){ }
            ...
            if (careerV.size()>0){
                try {
                    careerPath = (CareerPath) careerV.get(careerV.size()-1);
                } catch(Exception e){
    ...
    public static long insertExc(Employee employee) throws DBException {
        try {
            ...
            pstEmployee.setLong(FLD_EMP_DOC_ID, employee.getEmpDocId());
            pstEmployee.setInt(FLD_HISTORY_GROUP, employee.getHistoryGroup());
            pstEmployee.setInt(FLD_HISTORY_TYPE, employee.getHistoryType());
            pstEmployee.setLong(FLD_EMP_DOC_ID_GRADE, employee.getEmpDocIdGrade());
            pstEmployee.setString(FLD_SECONDARY_ID_TYPE, employee.getSecondaryIdType());
            pstEmployee.setString(FLD_SECONDARY_ID_NO, employee.getSecondaryIdNo());
            pstEmployee.setDate(FLD_SECONDARY_ID_VALID, employee.getSecondaryIDValid());
            pstEmployee.setDate(FLD_WA_FROM, employee.getWaFrom());
            pstEmployee.setDate(FLD_WA_TO, employee.getWaTo());
            pstEmployee.setLong(FLD_SUB_SECTION_ID, employee.getSectionId());
            pstEmployee.setLong(FLD_WA_SUB_SECTION_ID, employee.getWaSubSectionId());
            pstEmployee.setInt(FLD_ACKNOWLEDGE_STATUS, employee.getAcknowledgeStatus());
            pstEmployee.setInt(FLD_FINGER_CHECK, employee.getFingerCheck());
    ...
    public static long updateExc(Employee employee) throws DBException {
        try {
            if (employee.getOID() != 0) {
                ...
                pstEmployee.setDate(FLD_WA_FROM, employee.getWaFrom());
                pstEmployee.setDate(FLD_WA_TO, employee.getWaTo());
                pstEmployee.setLong(FLD_SUB_SECTION_ID, employee.getSubSectionId());
                pstEmployee.setLong(FLD_WA_SUB_SECTION_ID, employee.getWaSubSectionId());
                pstEmployee.setInt(FLD_ACKNOWLEDGE_STATUS, employee.getAcknowledgeStatus());
                pstEmployee.setInt(FLD_FINGER_CHECK, employee.getFingerCheck());
    ...
    public static Vector listDataTable(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT EMP.* FROM " + TBL_HR_EMPLOYEE + " AS EMP LEFT JOIN " + PstDivision.TBL_HR_DIVISION + " AS DV "
                    + " ON DV."+ PstDivision.fieldNames[PstDivision.FLD_DIVISION_ID]+ " = EMP."+ PstEmployee.fieldNames[PstEmployee.FLD_DIVISION_ID]
                    + " LEFT JOIN "+ PstPosition.TBL_HR_POSITION+ " AS POS ON POS."+ PstPosition.fieldNames[PstPosition.FLD_POSITION_ID] + ""
     ...
     * @return 
     */
    public static EmployeeSrcRekapitulasiAbs getEmployeeFilterBySpecialQuery(int limitStart, int recordToGet, String whereClause, String order) {
    ...
    public static void resultToObject(ResultSet rs, Employee employee) {
        try {
            ...
            employee.setEmpDocId(rs.getLong(fieldNames[FLD_EMP_DOC_ID])); //add by priska 20150904
            employee.setHistoryGroup(rs.getInt(fieldNames[FLD_HISTORY_GROUP])); //add by priska 20160104
            employee.setHistoryType(rs.getInt(fieldNames[FLD_HISTORY_TYPE])); //add by priska 20160104
            employee.setEmpDocIdGrade(rs.getLong(fieldNames[FLD_EMP_DOC_ID_GRADE])); //add by priska 20150904
            employee.setSubSectionId(rs.getLong(fieldNames[FLD_SUB_SECTION_ID]));
            employee.setWaSubSectionId(rs.getLong(fieldNames[FLD_WA_SUB_SECTION_ID]));
            employee.setAcknowledgeStatus(rs.getInt(fieldNames[FLD_ACKNOWLEDGE_STATUS]));
        } catch (Exception e) {
        }
    }
    ...
    public static int getCountEmployeeHaveDefaultSchedule(String whereClause) {
     ...
     public static int getCountDataTable(String whereClause) {
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT COUNT( EMP."+PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID]+") FROM " + TBL_HR_EMPLOYEE + " AS EMP LEFT JOIN " + PstDivision.TBL_HR_DIVISION + " AS DV "
                    + " ON DV."+ PstDivision.fieldNames[PstDivision.FLD_DIVISION_ID]+ " = EMP."+ PstEmployee.fieldNames[PstEmployee.FLD_DIVISION_ID]
                    + " LEFT JOIN "+ PstPosition.TBL_HR_POSITION+ " AS POS ON POS."+ PstPosition.fieldNames[PstPosition.FLD_POSITION_ID] + ""
                    + " = EMP."+ PstEmployee.fieldNames[PstEmployee.FLD_POSITION_ID];
            if (whereClause != null && whereClause.length() > 0) {
...
//                System.out.println("\tupdateBarcode : " + sql);
     ...
     * Date : 2016-01-13
     * Description : Update PIN Employee
     */
    public static int updatePin(long employeeId, String empPin) {
        DBResultSet dbrs = null;
        int status = 0;
        try {
            String sql = "";
            ...
            System.err.println("\tupdate PIN error : " + e.toString());
        } finally {
            DBResultSet.close(dbrs);
        }
        return status;
...
//            }
            ...
            while (rs.next()) {
                ...
                for (int j = 0; j < PayCOmp.size(); j++){
                   ...
                   payComponenttemp.setDecimalFormat(payComponentmini.getDecimalFormat());
...
//            }
    ...
    /**
     * Description : get Department, Section, Position
     * Date : 2015-06-15
     * Author : Putu Hendra
     */
    ...
    public static String getFullName(long employeeId){
        String str = "";
        try {
    ...
    /* Update by Hendra Putu | 2016-05-31 */
    public static int updateEmployeeParsial(String dataSet, long oid){
        int statusUpdate = 0;
        try {
            String query = "";
            query  = " UPDATE "+TBL_HR_EMPLOYEE;
            query += " SET "+dataSet+" ";
            query += " WHERE "+fieldNames[FLD_EMPLOYEE_ID]+"="+oid;
            statusUpdate = DBHandler.updateParsial(query);
        } catch(Exception e){
            System.out.println("update employee =>"+e.toString());
        }
        return statusUpdate;
    }
}