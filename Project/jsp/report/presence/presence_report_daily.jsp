...
//loop untuk b-Out / B-In
               ...
               if(attdConfig!=null && attdConfig.getConfigurasiReportScheduleDaily()==I_Atendance.CONFIGURASI_I_REPORT_DAILY_SCHEDULE_AND_CEK_BOX_ADA_DIBELAKANG){    
                ...
                rowx.add("<textarea name=\"" + inputName + "_note\" placeholder=\"saat mengisi note, reason tidak boleh A\" cols=\"15\"  rows=\"2\">"+presenceReportDaily.getNote1nd()+"</textarea>");
                //rowx.add("<input type=\"text\" name=\"" + inputName + "_note\" value=\"" + presenceReportDaily.getNote1nd() + "\" >");
...
function cmdAddAttd(employeeOid,lDateFrom){
  ...
  newWin.focus();
            ...
            function SetOk(FormName,id, nilai)
            {
                        var objCheckBoxes = document.forms[FormName].get;
                        document.getElementById(id).value=nilai;
                        document.getElementById("userSelect"+id).checked = true;
        ...
        function resetField(FormName,id){
           var x = document.getElementById(id+"_reasonSelect").selectedIndex;
              //alert(x);
           if (x == 1){
              alert("Reason tidak boleh A jika akan menambahkan note - " + x); 
           }
...
function cmdUpdatePos(){
	...
	function cmdListLast(){
        ...
        function cmdEmailSet(){
		document.frpresence.command.value="<%=Command.GOTO%>";
		document.frpresence.action="attendanceEmail.jsp";
                document.frpresence.target = "";
		document.frpresence.submit();
	}
        ...
        function generateOTForm(){	 
                document.frpresence.command.value="<%=Command.ASSIGN%>";
		document.frpresence.action="presence_report_daily.jsp";
                document.frpresence.target = "";
		document.frpresence.submit();
        }
       ...
       function reportPerEmployeeKadivPdf(){	 
                var linkPage = "<%=printroot%>.report.staffcontrol.AttRecordDailyPerEmployeeKadivPdf"; 
                document.frpresence.action="<%=printroot%>.report.staffcontrol.AttRecordDailyPerEmployeeKadivPdf"; 
                document.frpresence.target = "ReportPerEmployee";
                document.frpresence.submit();
                document.frpresence.target = "";
                //window.close(<%=printroot%>"/servlet/com.dimata.harisma.report.staffcontrol.AttRecordDailyPerEmployeePdf");
                    ...
                    <table width="100%" border="0" cellspacing="3" cellpadding="2">
                        <tr> 
                            <td width="100%"> 
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                            <tr> 
                                                <td height="20"> <font color="#FF6600" face="Arial"><strong>Attendance 
                                                        &gt; Daily Presence</strong></font> </td>
                                            </tr>
                                            <tr> 
                                                <td valign="top"> 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
      <td  style="background-color:<%=bgColorContent%>; " valign="top">
                            ...
                            <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                ...
                                <tr>
                                  ...
                                  <td width="30%" nowrap="nowrap">:
                                    <input class="masterTooltip" placeholder="Type Employee Number.." type="text" size="40" name="emp_number"  value="<%= sessEmpSchedule!=null && sessEmpSchedule.getEmpNum() != null? sessEmpSchedule.getEmpNum() : empNum %>" title="You can Input Payroll Number more than one, ex-sample : 1111,2222" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                  </td>
                                  <td width="5%" nowrap="nowrap"> Full Name </td>
                                  <td width="59%" nowrap="nowrap">:
                                    <input class="masterTooltip" type="text" size="50" placeholder="Type Full Name.." name="full_name"  value="<%= sessEmpSchedule!=null && sessEmpSchedule.getEmpFullName() != null ? sessEmpSchedule.getEmpFullName() : fullName%>" title="You can Input Full Name more than one, ex-sample : saya,kamu" class="elemenForm" onKeyDown="javascript:fnTrapKD()">
                                  </td>
                                </tr>
                                <tr>
    ...
    for (int i = 0; i < listCostDept.size(); i++) {
        ...
        if (prevCompany.equals(dept.getCompany())) {
              ...
              <td width="59%" nowrap="nowrap">:
                <%
					...
					//Vector listSec = PstSection.list(0, 0, sWhereClause, " SECTION ");
                                        String secWhere = "";
                                        if (dept_value.size()==1){
                                           secWhere = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + dept_value.get(0);
					} else {
                                           secWhere = PstSection.fieldNames[PstSection.FLD_DEPARTMENT_ID] + "=" + oidDepartment;
            ...
            <tr>
              ...
              <td width="5%" align="right" nowrap><div align="left">Reason </div></td>
              <td width="59%" nowrap="nowrap">:
                <%
				Vector reason_value = new Vector(1, 1);
				Vector reason_key = new Vector(1, 1);
				...
				%>
                <%=ControlCombo.drawTooltip("reason_status", "select...", ""+reason_sts, reason_value,  reason_key, "onkeydown=\"javascript:fnTrapKD()\"", reason_tooltip)%> </td>
            </tr>
            <tr>
              ...
              <td>:
                ...
                for(int attdIdx = 0 ; attdIdx < Presence.STATUS_ATT_ISTIRAHAT.length ; attdIdx++){
                    ...
                    %>
                <input name=<%=nameInp%> type="checkbox" checked value=1 >
                <%= Presence.STATUS_ATT_ISTIRAHAT[attdIdx] %> &nbsp;&nbsp;
                <%
                    }else{
                    %>
                <input name=<%=nameInp%> type="checkbox" value=1 >
                <%= Presence.STATUS_ATT_ISTIRAHAT[attdIdx]%> &nbsp;&nbsp;
                <%
                    }
                    // x.add(nameInp);
            ...
            %>
              ...
              <td width="59%" nowrap="nowrap">
                ...
                <td width="5%" align="right" nowrap><div align="left">Status </div></td>
              <td width="59%" nowrap="nowrap">
			  <table>
                  <tr>
                    <td width="83%" colspan="4">
					<table>
						...
						%>
                        <input type="checkbox" name="<%=nameInp%>"  checked="checked" value="<%=PstEmpSchedule.strPresenceStatusIdx[tc]%>"  />
                        <%=PstEmpSchedule.strPresenceStatus[tc]%> &nbsp;&nbsp;
                        <%}else{%>
                        <input type="checkbox" name="<%=nameInp%>"  value="<%=PstEmpSchedule.strPresenceStatusIdx[tc]%>"  />
                        <%=PstEmpSchedule.strPresenceStatus[tc]%> &nbsp;&nbsp;
                        <%}%>
                        <%
        ...
        %>
            ...
            <tr>
              <td>
				<table width="100%">
                  <tr>
                    <td><img src="<%=approot%>/images/attention-icon_x.png"/><span class="example" data-dropdown="#dropdown-1">Rule Edit Dutty</span>
                      <div id="dropdown-1" class="dropdown dropdown-tip has-icons">
                        <div class="dropdown-panel">
                          <table  border="0" class="tablecolor">
                            <tr>
                              <td class="tabbg"><table width="475px">
                                  <tr>
            ...
            <%
                ...
                //AppUser appUserSessPRD = userSessionPRD.getAppUser();
                    AppUser appUserX  =new AppUser();
                    try{
                        appUserX = PstAppUser.fetch(appUserSess.getOID());
                    } catch (Exception e){} 
                    
                int excelIOStatus = appUserX.getExcelIO();
            %>
 <%if ((dataStatus == DATA_PRINT && privPrint) || excelIOStatus == 1) {%>
...
%>
          ...
          <tr>
              <td bgcolor="#FFFF00"><img src="<%=approot%>/images/info3.png"><b> Message : </b> <%=message%> </td>
            </tr>
            <%}%>
          <tr>
              ...
              <td><table width="18%" border="0" cellspacing="1" cellpadding="1">
                  <tr>
                    <% if (privDepAdmin && privUpdatePresence && !isHRDLogin) { %>
                    <td width="15%"><a href="javascript:updateDaily()"><img src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" border="0"></a></td>
                    <td width="35%" nowrap="nowrap"><b><a href="javascript:updateDaily()" class="buttonlink">
                    <p class="masterTooltip" title=" Update this daily presence report according to data on the form without analyzing attendance status" >Update Daily Presence</p>
                    </a></b> </td>
                    <% } %>
                    <%if (privUpdatePresence && isHRDLogin) {%>
                    <td width="15%"><a href="javascript:updateDaily()"><img src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" border="0"></a></td>
                    ...
                    <td width="35%" nowrap="nowrap"><b><a href="javascript:updateAndAnalyzeDaily()" class="buttonlink">
                      <p class="masterTooltip" title=" Update this daily presence report and analyze attendance status according to schedule and IN/OUT attendance records" >Update & Analyze Daily Presence</p>
                      </a></b> </td>
                    ...
                    <td width="35%" nowrap="nowrap"><b><a href="javascript:updateOvertime()" class="buttonlink">Update Overtime</a></b> </td>
                    <%}%>
                    <%}%>
                    <td width="5%">&nbsp;</td>
                    <td width="15%"><a href="javascript:reportPdf()"><img src="<%=approot%>/images/pdf.png" width="24" height="24" border="0"></a></td>
                    <td width="30%" nowrap="nowrap"><b><a href="javascript:reportPdf()" class="buttonlink">Print Daily Presence</a></b> </td>
                    <td width="5%">&nbsp;</td>
                    <td width="15%"><a href="javascript:reportPerEmployeePdf()"><img src="<%=approot%>/images/pdf.png" width="24" height="24" border="0"></a></td>
                    <td width="30%" nowrap="nowrap"><b><a href="javascript:reportPerEmployeePdf()" class="buttonlink">Print  Daily Presence Per Employee</a></b> </td>
                    <td width="5%">&nbsp;</td>
                    <td width="5%">&nbsp;</td>
                    <td width="15%"><a href="javascript:reportPerEmployeeKadivPdf()"><img src="<%=approot%>/images/pdf.png" width="24" height="24" border="0"></a></td>
                    <td width="30%" nowrap="nowrap"><b><a href="javascript:reportPerEmployeeKadivPdf()" class="buttonlink">Print  Daily Presence Per Employee Kadiv</a></b> </td>
                    <td width="5%">&nbsp;</td>
                    
                  
                    <td width="15%"><a href="javascript:reportExcel()"><img src="<%=approot%>/images/excel.png" width="24" height="24" border="0"></a></td>
                    <td width="30%" nowrap="nowrap"><b><a href="javascript:reportExcel()" class="buttonlink">Print Daily Presence Excel</a></b> </td>
                   
                    <td width="15%"><a href="javascript:emailSet()"><img src="<%=approot%>/images/excel.png" width="24" height="24" border="0"></a></td>
                    <td width="30%" nowrap="nowrap"><b><a href="javascript:emailSet()" class="buttonlink">Email Send</a></b> </td>
                   
                    <td width="15%"><a href="javascript:cmdSendEmail()"><img src="<%=approot%>/images/email.png" width="24" height="24" border="0"></a></td>
                    <td width="30%" nowrap="nowrap"><b><a href="javascript:cmdSendEmail()" class="buttonlink">Email </a></b> </td>
                   
                    
                    <td width="15%"><a href="javascript:generateOTForm()"><img src="<%=approot%>/images/refresh2.jpg" width="24" height="24" border="0"></a></td>
                    <td width="35%" nowrap="nowrap"><b><a href="javascript:generateOTForm()" class="buttonlink">generateOTForm</a></b> </td>
                  </tr>
                </table></td>
            </tr>
            <%}//untuk command list%>
          ...
          <tr>
              <td width="2%" bgcolor="#FFFF00"> Message : <%= Errmsg %> </td>
            </tr>
            <%} else{
          ...
          <tr>
              <td><span class="style1"> <font face="Arial">Ket Symbol :</font> </span> <%=drawList(listScheduleSymbol)%> </td>
            </tr>
          <%}%>
