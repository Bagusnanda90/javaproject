<%-- 
    Document   : warningreprimand_bab
    Created on : 16-Jun-2016, 09:31:39
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Chapter | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Chapter List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showbabform" data-command="0"> Add New Chapter
                                            </button>
            ...
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       var onDone = function(data){
                           ...
                           $('#listWarningReprimandBab').DataTable( {
                       ...
                       sendData("<%= approot %>/masterdata/ajax/warningreprimand_bab_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    ...
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
			if(dataFor == 'showbabform'){
			    $(".addeditgeneral-title").html("Edit Chapter");
			}

                        }else{
                            if(dataFor == 'showbabform'){
                                $(".addeditgeneral-title").html("Add Chapter");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/warningreprimand_bab_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
