...
//        String tmpStr = new String("");
        ...
        try {
            ...
            System.out.println("<table width=\"" + getAreaWidth() + "\" class=\"" + getAreaStyle() + "\" cellspacing=\"0\">");
//            tmpStr = tmpStr + ("<table width=\"" + getAreaWidth() + "\" class=\"" + getAreaStyle() + "\" cellspacing=\"0\">");
            if (title != null && title.length() > 0) {
                out.print("<tr><td><div class=\"" + getTitleStyle() + "\">" + getTitle()
                        + "</div></td></tr>");
                System.out.println("<tr><td><div class=\"" + getTitleStyle() + "\">" + getTitle()
                        + "</div></td></tr>");
...
//                        + "</div></td></tr>");
            ...
            //out.print("<tr><td><div class=\"" + titleStyle + "\"><table id=\"" + "demoTable" + "\" class=\"" + "demoTable" + "\">");
            //out.print("<tr><td><table width=\"100%\" cellspacing=\"0\" id=\"GridView1\" class=\"table table-bordered\" style=\"width:100%;border-collapse:collapse;\" ><tr class=\"GridviewScrollHeader\">");
            ...
            System.out.println("<tr><td><table width=\"100%\" cellspacing=\"0\" id=\"GridView1\" class=\"table table-bordered\" style=\"width:100%;border-collapse:collapse;\" ><tr class=\"GridviewScrollHeader\">");
            // create header
            ...
            for (int h = 0; h < header.size(); h++) {
                ...
                if ((!colspan.equals("0")) || (!rowspan.equals("0"))) {
                    if ((!colspan.equals("0"))) {
                        ...
                        System.out.println("<td colspan=\"" + colspan + "\"");
//                        tmpStr = tmpStr +("<td colspan=\"" + colspan + "\"");
                    }
                    if ((!rowspan.equals("0"))) {
                        out.print("<td  rowspan=\"" + rowspan + "\"");
                        System.out.println("<td  rowspan=\"" + rowspan + "\"");
...
//                        tmpStr = tmpStr +("align=\"center\"");
                    ...
                    out.print(">" + (String) header.get(h) + "</td>");
                    System.out.println(">" + (String) header.get(h) + "</td>");
