 ...
 */
     ...
     public static Vector listDataTable(int limitStart, int recordToGet, String whereClause, String order) {
        ...
        try {
            String sql = "SELECT EMP.*,"
                    ...
                    + "IF ("+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_ORAL]+""
                    + " = "+PstEmpLanguage.GRADE_FAIR+", '"+PstEmpLanguage.gradeKey[PstEmpLanguage.GRADE_FAIR]+"', '"+PstEmpLanguage.gradeKey[PstEmpLanguage.GRADE_POOR]+"'))) AS ORAL_NAME,"
                    + "IF ("+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_WRITTEN]+""
                    + " = "+PstEmpLanguage.GRADE_SELECT+", '"+PstEmpLanguage.gradeKey[PstEmpLanguage.GRADE_SELECT]+"', "
                    + "IF ("+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_WRITTEN]+""
                    + " = "+PstEmpLanguage.GRADE_GOOD+", '"+PstEmpLanguage.gradeKey[PstEmpLanguage.GRADE_GOOD]+"', "
                    + "IF ("+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_WRITTEN]+""
                    + " = "+PstEmpLanguage.GRADE_FAIR+", '"+PstEmpLanguage.gradeKey[PstEmpLanguage.GRADE_FAIR]+"', '"+PstEmpLanguage.gradeKey[PstEmpLanguage.GRADE_POOR]+"'))) AS WRITTEN_NAME"
                    + " FROM "+PstEmpLanguage.TBL_HR_EMP_LANGUAGE+""
                    + " AS EMP INNER JOIN "+PstLanguage.TBL_HR_LANGUAGE+""
                    + " AS LANG ON EMP."+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_LANGUAGE_ID]+" ="
                    + " LANG."+PstLanguage.fieldNames[PstLanguage.FLD_LANGUAGE_ID]+"";
            if (whereClause != null && whereClause.length() > 0) {
                sql = sql + " WHERE " + whereClause;
}
    ...
    public static int getCountDataTable(String whereClause) {
        DBResultSet dbrs = null;
        try {
            String sql = "SELECT COUNT(EMP."+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_EMP_LANGUAGE_ID]+") "
                    + "FROM "+PstEmpLanguage.TBL_HR_EMP_LANGUAGE+""
                    + " AS EMP INNER JOIN "+PstLanguage.TBL_HR_LANGUAGE+""
                    + " AS LANG ON EMP."+PstEmpLanguage.fieldNames[PstEmpLanguage.FLD_LANGUAGE_ID]+" ="
                    + " LANG."+PstLanguage.fieldNames[PstLanguage.FLD_LANGUAGE_ID]+"";
