<%-- 
    Document   : upload_material_process_new
    Created on : Jan 6, 2016, 10:59:06 AM
    Author     : Dimata 007
--%>
...
catch(Exception e) 
{
	System.out.println("Exc2 when upload image : " + e.toString());
		...
		response.sendRedirect("training-program.jsp?command="+Command.EDIT+"&oid_training="+longOidDoc);
 %>
