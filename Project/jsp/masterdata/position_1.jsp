...
<html>
    <head>
        ...
        <title>Position List | Dimata Hairisma</title>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showposform" data-command="0">Add Position</button> 
