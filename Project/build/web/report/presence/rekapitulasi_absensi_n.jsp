<%-- 
    Document   : rekapitulasi_absensi_n
    Created on : 13-Jul-2017, 09:50:36
    Author     : Gunadi
--%>
		...
		$(this).getData({
		   ...
		   ajaxDataType	: dataType
            ...
            $("form#customSearch").submit(
                ...
                sendData("<%= approot %>/report/presence/ajax_rekapitulasi_absensi.jsp", dataSends, onDones, onSuccesses);
                return false;
            });
