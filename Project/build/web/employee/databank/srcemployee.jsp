                                                ...
                                                <td width="97%"> 
                                                  <table border="0" cellspacing="2" cellpadding="2" width="72%">
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                          ...
                                                          <%
                                                            ...
                                                            for (int i = 0; i < listDiv.size(); i++) {
                                                                    ...
                                                                    if (div.getValidStatus() != 0){ /* update by Hendra Putu | 2016-04-26 */
                                                      ...
                                                      %> 
                                                       <%=ControlCombo.draw(frmSrcSpecialEmployeeQuery.fieldNames[FrmSrcSpecialEmployeeQuery.FRM_FIELD_EMP_DIVISION_ID], "chosen-select", null,""+lDivisionId, div_key,div_value, null, "onChange=\"javascript:cmdUpdateDep()\"")%>
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      <td width="83%"> 
                                                         <%
                                                          ...
                                                          <%=ControlCombo.draw(frmSrcSpecialEmployeeQuery.fieldNames[FrmSrcSpecialEmployeeQuery.FRM_FIELD_DEPARTMENT], "chosen-select", null,""+lDepartment, dept_key, dept_value, null, "onChange=\"javascript:cmdUpdatePos()\"")%>
...
/*
        ...
        <%//=ControlCombo.draw("department", "elementForm", null, selectValueDepartment, dept_value, dept_key, " onkeydown=\"javascript:fnTrapKD()\"")%>
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      %> <%=ControlCombo.draw(frmSrcSpecialEmployeeQuery.fieldNames[FrmSrcSpecialEmployeeQuery.FRM_FIELD_SECTION], "chosen-select", null,""+lSectionId, sec_key, sec_value, null, "onChange=\"javascript:fnTrapKD()\"")%></td>
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      ...
                                                      %>
                                                      <%=ControlCombo.draw(frmSrcSpecialEmployeeQuery.fieldNames[FrmSrcSpecialEmployeeQuery.FRM_FIELD_POSITION], "chosen-select", null,""+lPositionId, pos_key, pos_value, null, "onChange=\"javascript:fnTrapKD()\"")%>
                                                      </td>
                                                    </tr>
                                                    ...
                                                    <td width="17%" nowrap> 
                                                      ...
                                                      %> 
                                                      <%=ControlCombo.draw(frmSrcSpecialEmployeeQuery.fieldNames[FrmSrcSpecialEmployeeQuery.FRM_FIELD_GRADE], "chosen-select", null,""+lGradeId, gra_key, gra_value, null, "onChange=\"javascript:fnTrapKD()\"")%>
                                                      </td>
						    ...
						    <tr align="left" valign="top"> 
                                                    ...
                                                    <tr align="left" valign="top"> 
                                                      <td nowrap> <%=dictionaryD.getWord(I_Dictionary.PAYROLL_GROUP)%> </td>
                                                      <td width="83%"> <%
                                                      ...
                                                      <td width="83%"> <table width="30%" border="0" cellspacing="0" cellpadding="0">
                                                          <tr> 
                                                            ...
                                                            <td width="28%" class="command" nowrap>
                                                                <a href="javascript:cmdSearch()"><%=dictionaryD.getWord("SEARCH")%> 
                                                              <%=dictionaryD.getWord(I_Dictionary.EMPLOYEE)%></a>
                                                            </td>
                                                            <% if (sdmDivisionOid != 0 && emplx.getDivisionId() == sdmDivisionOid){%>
