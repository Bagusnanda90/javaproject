...
<html>
    <head>
        ...
        <title>Master Company | Dimata Hairisma</title>
                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showCompanyForm">
	...
	$(document).ready(function(){
            ...
            $("#Company").addClass("treeview active");
            $("#subCompany").addClass("treeview active");
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
                        $(".addeditgeneral-title").html("Edit Company");
		    }else{
                        $(".addeditgeneral-title").html("Add Company");
		    }                    
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCompany", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxCompany", null, true, "json");
		...
		validateOptions("#<%= FrmCompany.fieldNames[FrmCompany.FRM_FIELD_COMPANY] %>", 'text', 'has-error', 1, null);
	    }
	    ...
	    function runDataTables(dataFor){
                dataTablesOptions("#companyElement", "tableCompanyElement", "AjaxCompany", "listCompany", callBackDataTables);
            }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletegeneral", ".<%= FrmCompany.fieldNames[FrmCompany.FRM_FIELD_COMPANY_ID]%>");
