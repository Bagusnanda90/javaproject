<%-- 
    Document   : upload_award
    Created on : 26-Jul-2016, 10:09:02
    Author     : Acer
--%>
...
long oidEmpAward = FRMQueryString.requestLong(request, "detail_oid");
long oidMain = FRMQueryString.requestLong(request, "main_id");
...
Vector listEmpAward = new Vector(1,1);

/*switch statement */
iErrCode = ctrlEmpAward.action(iCommand, oidEmpAward, request, emplx.getFullName(), appUserIdSess);
/* end switch*/


Vector vectPict = new Vector(1,1);
vectPict.add(""+oidEmpAward);
 
Vector vectPictDoc = new Vector(1,1);
vectPictDoc.add(""+oidMain);
 
session.putValue("SELECTED_PHOTO_SESSION", vectPict);
session.putValue("OID_DOC", vectPictDoc);
...
function cmdUpload(){
	...
	document.frm_upload_pict.action="upload_data_process.jsp";
                          ...
                          <tr> 
                            <td valign="top"> <!-- #BeginEditable "content" --> 
                              <form name="frm_upload_pict" method ="post" enctype="multipart/form-data" action="">
								...
								<input type="hidden" name="detail_oid" value="<%=oidDetail%>">
                                                                <input type="hidden" name="main_id" value="<%=oidMain%>">
                                                ...
                                                <td height="8"  colspan="3"> 
                                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    ...
                                                    <% if(oidDetail != 0){
                                                            ...
                                                            try{
                                                                 objDataUploadDetail = PstDataUploadDetail.fetchExc(oidDetail);
                                                            }catch(Exception exc){
                                                                 objDataUploadDetail = new DataUploadDetail();
                                                            }
                                                      %>
                                                    <tr align="left" valign="top"> 
                                                      <td height="14" valign="middle" colspan="3" class="listedittitle"> 
                                                        <table width="100%" border="0" cellspacing="2" cellpadding="1">
                                                          <tr> 
                                                            <td width="17%"><strong>Title </strong>
                                                               </td>
                                                            <td width="2%">:</td>
                                                            <td width="81%"><strong><%=objDataUploadDetail.getDataDetailTitle()%></strong></td>
                                                          </tr>
                                                          <tr> 
                                                            <td width="17%"><strong>Description</strong></td>
                                                            <td width="2%">:</td>
                                                            <td width="81%"><strong><%=objDataUploadDetail.getDataDetailDesc()%></strong></td>
                                                          </tr>
                                                        </table>
                                                      </td>
                                                    </tr>
