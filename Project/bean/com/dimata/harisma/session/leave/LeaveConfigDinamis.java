 ...
 */
public class LeaveConfigDinamis implements I_Leave{
    ...
    private int iEntitleType = AL_ENTITLE_BY_COMMENCING_PERIODE;
    ...
    private boolean isALforAllowance = false;//update by priska 2015-08-05 false 
    private boolean isLLforAllowance = false;
...
//    public static final int LEVEL_CORPORATE = 0;
//    public static final int LEVEL_DEPARTMENT_HEAD_A = 1;
//    public static final int LEVEL_DEPARTMENT_HEAD_B = 2; 
//    public static final int LEVEL_EXECUTIVE = 3; 
//    public static final int LEVEL_RANKED_A = 4; 
//    public static final int LEVEL_RANKED_B = 5 ; 
//    public static final int LEVEL_SUPERVISOR= 6; 
//    public static final int LEVEL_TEAM_LEADER= 7; 
      private String[] strLevels = PstLevel.listNameLevel(0,0,"",""); 
...
//    public static final int CATEGORY_PROBATION = 8;
       private String[] strCategory = PstEmpCategory.listNameCategory(0,0,"",""); 
...
//    //priska 20150805 menambahkan get AL Allowance //tunjangan
//    public boolean getALallowance(long LeaveAplicationID,long periodeId, long employeeId){
//        if(LeaveAplicationID == 0 || periodeId == 0 || employeeId == 0 ){
//             return true;
//         }
...
//                        PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS HLA "+ 
//                        " INNER JOIN " + PstAlStockTaken.TBL_HR_AL_STOCK_TAKEN +" AS HAST "+
//                        " ON HLA."+ PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_LEAVE_APPLICATION_ID] +
//                        " WHERE HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_AL_ALLOWANCE] + " = 1 " +
//                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = " + employeeId +
//                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " = 3 " +
//                        " AND HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " BETWEEN " + Formater.formatDate(payPeriod.getStartDate(), "yyyy-MM-dd 00:00:00") + " AND " + Formater.formatDate(payPeriod.getEndDate(), "yyyy-MM-dd 23:59:59") + " " ;
//            System.out.println("SQL Mencari Al Allowance :::::: " + sql);
...
//        }
//         return isALforAllowance;
//    }
//    
//    //priska 20150805 menambahkan get LL Allowance //tunjangan
//    public boolean getLLallowance(long LeaveAplicationID,long periodeId, long employeeId){
//        if(LeaveAplicationID == 0 || periodeId == 0 || employeeId == 0 ){
//             return true;
//         }
//        PayPeriod payPeriod = null;
...
//            String sql = " SELECT * FROM "+
//                        PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS HLA "+ 
//                        " INNER JOIN " + PstLlStockTaken.TBL_HR_LL_STOCK_TAKEN +" AS HAST "+
//                        " ON HLA."+ PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = HAST." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_LEAVE_APPLICATION_ID] +
//                        " WHERE HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LL_ALLOWANCE] + " = 1 " +
//                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = " + employeeId +
//                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " = 3 " +
//                        " AND HAST." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE] + " BETWEEN " + Formater.formatDate(payPeriod.getStartDate(), "yyyy-MM-dd 00:00:00") + " AND " + Formater.formatDate(payPeriod.getEndDate(), "yyyy-MM-dd 23:59:59") + " " ;
//            System.out.println("SQL Mencari Al Allowance :::::: " + sql);
//            dbrs = DBHandler.execQueryResult(sql);
//            ResultSet rs = dbrs.getResultSet();
//            while (rs.next()) {
...
//            DBResultSet.close(dbrs);
//        }
//         return isLLforAllowance;
//    }
    

    //priska menambahkan get al ll apakah ada al&ll allowance dalam setahun
    public boolean ALallowanceStatus(AlStockTaken alStockTaken,long periodeId, long employeeId){
        if(alStockTaken == null || periodeId == 0 || employeeId == 0 ){
             return false;
         }
        PayPeriod payPeriod = null;
        try{
        ...
        try {
            ...
            String sql = " SELECT DISTINCT(HLA."+ PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] +" ) FROM "+
                        PstLeaveApplication.TBL_LEAVE_APPLICATION + " AS HLA "+ 
                        " INNER JOIN " + PstAlStockTaken.TBL_HR_AL_STOCK_TAKEN +" AS HAST "+
                        " ON HLA."+ PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_LEAVE_APPLICATION_ID] + " = HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_LEAVE_APPLICATION_ID] +
                        " WHERE HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_AL_ALLOWANCE] + " = 1 " +
                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = " + employeeId +
                       // " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " = 3 " +
                       // " AND HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " BETWEEN "+payPeriod.getPaySlipDate().getYear()+"-01-01 00:00:00 AND "+payPeriod.getPaySlipDate().getYear()+"-12-31 23:59:59 " ;
                        " AND HAST." + PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE] + " BETWEEN \"" + Formater.formatDate(alStockTaken.getTakenDate(), "yyyy-01-01 00:00:00") + "\" AND \"" + Formater.formatDate(alStockTaken.getTakenDate(), "yyyy-12-31 23:59:59") + "\" " +
                        "AND (DATEDIFF(HAST."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_FINNISH_DATE]+", HAST."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE]+") > 2)";
//          
            System.out.println("SQL Mencari Al Allowance :::::: " + sql);
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            ...
            if ((status == true) && (((((alStockTaken.getTakenFinnishDate().getTime()) - (alStockTaken.getTakenDate().getTime())) / (24L * 60L * 60L * 1000L)) ) > (2) )){
     ...
     public boolean getALallowance(LeaveApplication leaveApplication){
        ...
        Vector listAlTaken = PstAlStockTaken.getAlTakenDateDiff_3(leaveApplication.getOID(), leaveApplication.getEmployeeId());
        boolean status = false;
        for (int i = 0; i < listAlTaken.size(); i++ ){
           AlStockTaken alStockTaken = (AlStockTaken) listAlTaken.get(i);
           long periodId = PstPayPeriod.getPayPeriodIdBySelectedDate(alStockTaken.getTakenDate()); 
           boolean AlAllowanceStatus = ALallowanceStatus(alStockTaken, periodId, leaveApplication.getEmployeeId());
           if (AlAllowanceStatus){
               status = true;
           }
        }
        ...
        try{
            if (status){
                ...
                long save =  PstLeaveApplication.updateExc(leaveApplication);
            }
        }catch (Exception e){
     ...
     public boolean getLLallowance(LeaveApplication leaveApplication){
        ...
        Vector listLlTaken = PstLlStockTaken.getLlTaken(leaveApplication.getOID(), leaveApplication.getEmployeeId());
        boolean status = false;
        for (int i = 0; i < listLlTaken.size(); i++ ){
           LlStockTaken llStockTaken = (LlStockTaken) listLlTaken.get(i);
           long periodId = PstPayPeriod.getPayPeriodIdBySelectedDate(llStockTaken.getTakenDate()); 
           boolean LlAllowanceStatus = LLallowanceStatus(llStockTaken, periodId, leaveApplication.getEmployeeId());
           if (LlAllowanceStatus){
               status = true;
           }
        }
     ...
     //priska menambahkan get al ll apakah ada al&ll allowance dalam setahun
    public boolean LLallowanceStatus(LlStockTaken llStockTaken,long periodeId, long employeeId){
        if(llStockTaken == null || periodeId == 0 || employeeId == 0 ){
             return false;
         }
        PayPeriod payPeriod = null;
        try{
        ...
        try {
            ...
            String sql =" SELECT * FROM "+
                        ...
                        " AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_EMPLOYEE_ID] + " = " + employeeId +
                        //" AND HLA." + PstLeaveApplication.fieldNames[PstLeaveApplication.FLD_DOC_STATUS] + " = 3 " +
                        " AND HAST." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE] + " BETWEEN \"" + Formater.formatDate(llStockTaken.getTakenDate(), "yyyy-01-01 00:00:00") + "\" AND \"" + Formater.formatDate(llStockTaken.getTakenDate(), "yyyy-12-31 23:59:59") + "\" " ;
//        
            System.out.println("SQL Mencari Al Allowance :::::: " + sql);
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
...
//
//            if ((status == true) && (((((llStockTaken.getTakenFinnishDate().getTime()) - (llStockTaken.getTakenDate().getTime())) / (24L * 60L * 60L * 1000L)) ) > (2) )){
//                
//                 status =  true; 
//                
//            } else {
...
//        
            ...
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                Date startDate =  (rs.getDate(" HAST."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE]));
                Date endDate =  (rs.getDate(" HAST."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_FINNISH_DATE]));
    ...
    public boolean getLLallowanceByPeriode(long periodeId, long employeeId){
        ...
        try {
            ...
            String sql =" SELECT * FROM "+
                        ...
                        " AND HAST." + PstLlStockTaken.fieldNames[PstLlStockTaken.FLD_TAKEN_DATE] + " BETWEEN \"" + Formater.formatDate(payPeriod.getStartDate(), "yyyy-MM-dd 00:00:00") + "\" AND \"" + Formater.formatDate(payPeriod.getEndDate(), "yyyy-MM-dd 23:59:59") + "\" " ;
//        
            System.out.println("SQL Mencari Ll Allowance :::::: " + sql);
            dbrs = DBHandler.execQueryResult(sql);
            ResultSet rs = dbrs.getResultSet();
            while (rs.next()) {
                Date startDate =  (rs.getDate(" HAST."+PstAlStockTaken.fieldNames[PstAlStockTaken.FLD_TAKEN_DATE]));
...
//                    }
//                }
                 if ((commencingDate.getYear() < checkDate.getYear()) && (LoSDays >= (365 * 10) && ((commencingDate.getMonth() == checkDate.getMonth()) || (commencingDate.getMonth() < checkDate.getMonth()) ) ) ) { // length of service >= 10 tahun
                        //update by satrya 2013-02-27
                        //if (LoSDays >= (365 * 10) && ((commencingDate.getMonth() == checkDate.getMonth()) {
                        //update by satrya 2014-03-05
                        //ini akan di update di service center
    ...
    public int getIndexLevel(String level) {
        ...
        if(strLevels!=null && strLevels.length>0){
     ...
     * @return
     */
//    public Vector getApprovalEmployeeTopLink(long employeeId) {
//        Vector listEmployee = new Vector();
//        String whereClause  = "HE." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID] + " = "+employeeId+" AND HMP."+ PstTopPosition.fieldNames[PstTopPosition.FLD_TYPE_OF_LINK] + " = 3" ;
//        String listTopLink = PstTopPosition.listEmployeeTopPositionId(0, 0, whereClause, "");
//        
//        String whereClause2  = "HE." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID] + " = "+employeeId+" AND HMP."+ PstMappingPosition.fieldNames[PstMappingPosition.FLD_TYPE_OF_LINK] + " = 3" ;
//        String listTopLink2 = PstMappingPosition.listEmployeeTopPositionId(0, 0, whereClause2, "");
//        
...
////        Vector listEmployeeDivisionTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink+")" , "", 0,0, employee.getDivisionId());
////        
...
////        }
////        } else 
//        if (!listTopLink2.equals("")){
//        listTopLink2 = listTopLink2.substring(0, (listTopLink2.length() - 1 ));
//       
//        Employee employee = new Employee();
//        try {
//            employee = PstEmployee.fetchExc(employeeId);
...
//            
//        }
//        Vector listEmployeeSectionTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink2+")" , "", employee.getSectionId(), employee.getDepartmentId() , employee.getDivisionId());
//        Vector listEmployeeDepartmentTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink2+")" , "", 0 ,employee.getDepartmentId(), employee.getDivisionId());
//        Vector listEmployeeDivisionTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink2+")" , "", 0,0, employee.getDivisionId());
//        
//        if (listEmployeeSectionTopLink.size() != 0 || listEmployeeSectionTopLink.size() > 0 ){
//            listEmployee = listEmployeeSectionTopLink;
//        } else if (listEmployeeDepartmentTopLink.size() != 0 || listEmployeeDepartmentTopLink.size() > 0 ){
...
//    }
      ...
      public Vector getApprovalEmployeeTopLink(long employeeId, int typeOfLink) {
        ...
        String whereClause2  = "HE." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID] + " = "+employeeId+" AND HMP."+ PstMappingPosition.fieldNames[PstMappingPosition.FLD_TYPE_OF_LINK] + " = "+typeOfLink ;
        String listTopLink2 = PstMappingPosition.listEmployeeTopPositionId(0, 0, whereClause2, "");
        ...
        Vector listEmployeeSectionTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink2+")" , "", employee.getSectionId(), employee.getDepartmentId() , employee.getDivisionId());
        Vector listEmployeeDepartmentTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink2+")" , "", 0 ,employee.getDepartmentId(), employee.getDivisionId());
        Vector listEmployeeDivisionTopLink = PstEmployee.listEmployeeApprovalTopLink(0, 0, " POSITION_ID IN ("+listTopLink2+")" , "", 0,0, 0);
     ...
     * @return
     */
 public Vector getApprovalEmployeeTopLinkByLevel(long employeeId, int typeOfLink,int levelPoint) {
       String byLevelId = "";
       try{
 ...
 public Vector getApprovalEmployeeTopLinkByLevelMultipleEmp(String employeeId, int typeOfLink,int levelPoint) {
    ...
    //priska menambahkan untuk top link pada position employee approval 20160807
    public Vector listEmployeeTopLink (long employeeId){
        Vector listEmployee = new Vector();
        String whereClause  = "HE." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID] + " = "+employeeId+" AND HMP."+ PstTopPosition.fieldNames[PstTopPosition.FLD_TYPE_OF_LINK] + " = 3" ;
        String listTopLink = PstTopPosition.listEmployeeTopPositionId(0, 0, whereClause, "");
        listTopLink = listTopLink.substring(0, (listTopLink.length() - 1 ));
        ...
        Vector listEmployeeSectionTopLink = PstEmployee.list(0, 0, "SECTION_ID = " + employee.getSectionId() + " AND POSITION_ID IN ("+listTopLink+")" , "");
        Vector listEmployeeDepartmentTopLink = PstEmployee.list(0, 0, "DEPARTMENT_ID = " + employee.getDepartmentId() + " AND POSITION_ID IN ("+listTopLink+")" , "");
        Vector listEmployeeDivisionTopLink = PstEmployee.list(0, 0, "DIVISION_ID = " + employee.getDivisionId() + " AND POSITION_ID IN ("+listTopLink+")" , "");
