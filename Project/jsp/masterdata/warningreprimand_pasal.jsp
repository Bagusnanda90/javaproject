<%-- 
    Document   : warningreprimand_pasal
    Created on : 16-Jun-2016, 09:35:10
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Article | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Article List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showpasalform" data-command="0"> Add New Article</button>
            ...
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       var onDone = function(data){
                           ...
                           $('#listWarningReprimandPasal').DataTable( {
                       ...
                       sendData("<%= approot %>/masterdata/ajax/warningreprimand_pasal_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    ...
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
			if(dataFor == 'showpasalform'){
			    $(".addeditgeneral-title").html("Edit Article");
			}

                        }else{
                            if(dataFor == 'showpasalform'){
                                $(".addeditgeneral-title").html("Add Article");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/warningreprimand_pasal_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
