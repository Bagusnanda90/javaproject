...
public class FrmRecrApplication extends FRMHandler implements I_FRMInterface, I_FRMType 
{
	...
	public static final int FRM_FIELD_CHILD7_SEX			=  57 ;
        ...
        public static final int FRM_FIELD_DATE_AVAILABLE_STR            =  64 ;
        public static final int FRM_FIELD_BIRTH_DATE_STR                =  65 ;
        public static final int FRM_FIELD_VALID_UNTIL_STR               =  66 ;
	...
	public static String[] fieldNames = {
		...
		"FRM_FIELD_CHILD7_BIRTHDATE",  
                ...
                "SKILL",
                "FRM_FIELD_DATE_AVAILABLE_STR",
                "FRM_FIELD_BIRTH_DATE_STR",
                "FRM_FIELD_VALID_UNTIL_STR"
	...
	public void requestEntityObject(RecrApplication recrApplication) {
		try{
			this.requestParam();
                        ...
                        String availableStr = getString(FRM_FIELD_DATE_AVAILABLE_STR);
                        String birthDateStr = getString(FRM_FIELD_BIRTH_DATE_STR);
                        String vaildStr = getString(FRM_FIELD_VALID_UNTIL_STR);
			...
			recrApplication.setDateAvailable(availableStr.equals("") ? getDate(FRM_FIELD_DATE_AVAILABLE) : java.sql.Date.valueOf(availableStr));
			...
			recrApplication.setBirthDate(birthDateStr.equals("") ? getDate(FRM_FIELD_BIRTH_DATE) : java.sql.Date.valueOf(birthDateStr));
			...
			recrApplication.setValidUntil(vaildStr.equals("") ? getDate(FRM_FIELD_VALID_UNTIL) : java.sql.Date.valueOf(vaildStr));
