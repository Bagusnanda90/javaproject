<%-- 
    Document   : race
    Created on : 15-Jun-2016, 09:04:53
    Author     : Acer
--%>
...
<html>
    <head>
        ...
        <title>Master Race | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Race List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showraceform" data-command="0">Add Race</button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/race_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showraceform'){
                        $(".addeditgeneral-title").html("Edit Race");
                        }

                        }else{
                            if(dataFor == 'showraceform'){
                                $(".addeditgeneral-title").html("Add Race");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/race_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
