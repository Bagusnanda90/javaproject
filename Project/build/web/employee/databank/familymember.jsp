...
<% int appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_DATABANK, AppObjInfo.OBJ_DATABANK_FAMILY_MEMBER);%>
...
//variable declaration
            ...
            // data upload dedy 20160318
            className = familyMember.getClass().getName();
            ...
            if (iCommand == Command.SAVE) {
                for (int i = 0; i < 50; i++) {
                    ...
                    String cardId = FRMQueryString.requestString(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_CARD_ID] + "_" + i);
                    long noTelp = FRMQueryString.requestLong(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_NO_TELP] + "_" + i);
                    String bpjsNum = FRMQueryString.requestString(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BPJS_NUM] + "_" + i);
                    String jobPlace = FRMQueryString.requestString(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_JOB_PLACE] + "_" + i);
                    String jobPosition = FRMQueryString.requestString(request, FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_JOB_POSITION] + "_" + i);
                    ...
                    famMember.setCardId(cardId);
                    famMember.setNoTelp(noTelp);
                    famMember.setBpjsNum(bpjsNum);
                    famMember.setJobPlace(jobPlace);
                    famMember.setJobPosition(jobPosition);
...
<html><!-- #BeginTemplate "/Templates/maintab.dwt" -->
    <head>
        ...
        <script language="JavaScript">
            ...
            // data upload dedy 20160318
            function cmdDetailUp(oidFamilyMember, className){
                window.open("<%=approot%>/system/dataupload/data_upload.jsp?object_id="+oidFamilyMember+"&classname="+className, null, "height=800,width=800,status=yes,toolbar=no,menubar=no,location=center,scrollbars=yes");
            }
                ...
                <div class="content">
                    ...
                    <table cellspacing="1" cellpadding="1" class="tblStyle">
                        <tr>
                            ...
                            <td valign="top" class="title_tbl">
                                <div align="center"><b>Job / Address</b></div>
                            </td>    
                            <td valign="top" class="title_tbl">
                                <div align="center"><strong>ID KTP</strong></div>
                            </td> 
                            <td valign="top" class="title_tbl">
                                <div align="center"><b><%=dictionaryD.getWord(I_Dictionary.EDUCATION) %></b> / <b>Religion</b></div>
                            </td>
                            <td valign="top" class="title_tbl">
                                <div align="center"><b>No Telp</b></div>
                            </td>
                            <td valign="top" class="title_tbl">
                                <div align="center"><b>BPJS NUM</b></div>
                            </td> 
                           <!-- <td valign="top" class="title_tbl">
                                <div align="center"><b>JOB PLACE</b></div>
                            </td>
                            <td valign="top" class="title_tbl">
                                <div align="center"><b>JOB POSITION</b></div>
                            </td> -->
                            <td valign="top" class="title_tbl">
                        ...
                        <%  
                            ...
                            for (int idx=0; idx < 50; idx++ ){ 
                                ...
                                if (vctMember != null && vctMember.size() > 0 && vctMember.size() > idx) {
                                    ...
                                    detailData = "<a href=\"javascript:cmdDetailUp('"+famX.getOID()+"','"+className+"')\">Detail</a>";
                                } else {
                                    colorTd = "";
                                    btnDelete = "";
                                    detailData = "";
                      ...
                      <% }%>
                                ...
                                <%  Vector relationX_value = new Vector(1, 1);
                                    ...
                                    <td valign="top"><%=ControlDate.drawDateEmpty(FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BIRTH_DATE] + "_"+idx, famX.getBirthDate(), "formElemen", 0, -115)%>
                                        ...
                                        Ignore </td>
                                    <td valign="top">
                                        <input type="text" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_JOB]%>_<%=idx%>"  value="<%= famX.getJob()%>" class="elemenForm" size="30"> <br>
                                    ...
                                    <td valign="top">
                                        <input type="text" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_CARD_ID]%>_<%=idx%>" value="<%= famX.getCardId() %>" />
                                    </td>
                                    <td valign="top">                                                                                                                                                                                                                                                                                           
                            ...
                            <td valign="top">
                                <input type="text" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_NO_TELP]%>_<%=idx%>"  value="<%= famX.getNoTelp() %>" class="elemenForm" size="10">
                            </td>                                                                                                                                      
                            <td valign="top">
                                <input type="text" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_BPJS_NUM]%>_<%=idx%>"  value="<%= famX.getBpjsNum() %>" class="elemenForm" size="10">
                            </td>
                           <!-- <td valign="top">
                                <input type="hidden" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_JOB_PLACE]%>_<%=idx%>"  value="<%= famX.getJobPlace() %>" class="elemenForm" size="10">
                            </td>
                            <td valign="top">
                                <input type="hidden" name="<%=FrmFamilyMember.fieldNames[FrmFamilyMember.FRM_FIELD_JOB_POSITION]%>_<%=idx%>"  value="<%= famX.getJobPosition() %>" class="elemenForm" size="10">
                            </td> -->
                            <td>
                                <%=btnDelete%>
                            </td>
