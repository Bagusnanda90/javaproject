...
<html>
    <head>
        ...
        <title>Master SubSection | Dimata Hairisma</title>
                        ...
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showSubSectionForm">
                                    <i class="fa fa-plus"></i> Add SubSection
                                </button>
                                <button class="btn btn-danger btndeletegeneral" data-for="subsection">
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
                        $(".addeditgeneral-title").html("Edit SubSection");
		    }else{
                        $(".addeditgeneral-title").html("Add SubSection");
		    }                    
	    ...
	    function runDataTables(dataFor){
                dataTablesOptions("#subSectionElement", "tableSubSectionElement", "AjaxSubSection", "listSubSection", callBackDataTables);
            }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletegeneral", ".<%= FrmSubSection.fieldNames[FrmSubSection.FRM_FIELD_SECTION_ID]%>");
