<%-- 
    Document   : training
    Created on : May 10, 2016, 11:53:56 AM
    Author     : Dimata 007
--%>
...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_DATABANK, AppObjInfo.OBJ_DATABANK_TRAINING); %>
	...
	function cmdView(trainingId){
        ...
        <script type="text/javascript">
            ...
            function loadList(training_cari) {
                ...
                xmlhttp.open("GET", "training-ajax.jsp?training_cari=" + training_cari +"&rb_cari="+valueCheck+"&employee_oid="+oidEmp+"&priv_edit=<%= privUpd %>&priv_del=<%= privDlt %>", true);
                xmlhttp.send(); 
            }
            ...
            function cmdListFirst(start){       
                ...
                xmlhttp.open("GET", "training-ajax.jsp?training_cari=0&rb_cari="+valueCheck+"&command=" + <%=Command.FIRST%> + "&start="+start+"&employee_oid="+oidEmp+"&priv_edit=<%= privUpd %>&priv_del=<%= privDlt %>", true);
                xmlhttp.send();
            }
            ...
            function cmdListPrev(start){
                ...
                xmlhttp.open("GET", "training-ajax.jsp?training_cari=0&rb_cari="+valueCheck+"&command=" + <%=Command.PREV%> + "&start="+start+"&employee_oid="+oidEmp+"&priv_edit=<%= privUpd %>&priv_del=<%= privDlt %>", true);
                xmlhttp.send();
            }
            ...
            function cmdListNext(start){
                ...
                xmlhttp.open("GET", "training-ajax.jsp?training_cari=0&rb_cari="+valueCheck+"&command=" + <%=Command.NEXT%> + "&start="+start+"&employee_oid="+oidEmp+"&priv_edit=<%= privUpd %>&priv_del=<%= privDlt %>", true);
                xmlhttp.send();
            }
            ...
            function cmdListLast(start){
                ...
                xmlhttp.open("GET", "training-ajax.jsp?training_cari=0&rb_cari="+valueCheck+"&command=" + <%=Command.LAST%> + "&start="+start+"&employee_oid="+oidEmp+"&priv_edit=<%= privUpd %>&priv_del=<%= privDlt %>", true);
                xmlhttp.send();
            }
