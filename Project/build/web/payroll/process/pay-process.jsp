...
<%
            ...
            if (iCommand == Command.LIST || iCommand == Command.SAVE || iCommand == Command.ADD) {
                if (periodId != 0){
                    listEmpLevel = PstPayEmpLevel.listEmpLevelwithDateResign(levelCode, checkValues,oidDivision, oidDepartment, min_commencing , PstEmployee.NO_RESIGN, payPeriod123.getStartDate(), payPeriod123.getEndDate(),rsgn_startdate, rsgn_enddate,payrollGroupId );
                } else {
