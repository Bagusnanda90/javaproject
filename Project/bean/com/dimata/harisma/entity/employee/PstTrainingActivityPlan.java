...
public class PstTrainingActivityPlan extends DBHandler implements I_DBInterface, I_DBType, I_PersintentExc, I_Language {
    ...
    public static final int FLD_TRAINING_TITLE = 11;
    ...
    public static TrainingActivityPlan fetchExc(long oid) throws DBException {
        try {
            ...
            trainingactivityplan.setTrainingTitle(pstTrainingActivityPlan.getString(FLD_TRAINING_TITLE));
            trainingactivityplan.setPositionId(pstTrainingActivityPlan.getLong(FLD_POSITION_ID));
            //trainingactivityplan.setTrainingId(pstTrainingActivityPlan.getlong(FLD_TRAINING_ID));
    ...
    public static long insertExc(TrainingActivityPlan trainingactivityplan) throws DBException {
        try {
            ...
            pstTrainingActivityPlan.setString(FLD_TRAINING_TITLE, trainingactivityplan.getTrainingTitle());
            pstTrainingActivityPlan.setLong(FLD_POSITION_ID, trainingactivityplan.getPositionId());
    ...
    public static void resultToObject(ResultSet rs, TrainingActivityPlan trainingactivityplan) {
        try {
            ...
            trainingactivityplan.setTrainingTitle(rs.getString(PstTrainingActivityPlan.fieldNames[PstTrainingActivityPlan.FLD_TRAINING_TITLE]));
            trainingactivityplan.setPositionId(rs.getLong(PstTrainingActivityPlan.fieldNames[PstTrainingActivityPlan.FLD_POSITION_ID]));
        } catch (Exception e) {
        }
    }
    ...
    public static Vector getSearchTrainer(String str) {
        DBResultSet dbrs = null;
        Vector trainer = new Vector();
        ...
        try {
            String sql = " SELECT DISTINCT " + PstTrainingActivityPlan.fieldNames[PstTrainingActivityPlan.FLD_TRAINER]
                    + " FROM " + PstTrainingActivityPlan.TBL_HR_TRAINING_ACTIVITY_PLAN;
            sql += " WHERE "+PstTrainingActivityPlan.fieldNames[PstTrainingActivityPlan.FLD_TRAINER]+ " LIKE '%"+str+"%'";
            sql += " ORDER BY " + PstTrainingActivityPlan.fieldNames[PstTrainingActivityPlan.FLD_TRAINER];
    ...
    public static Vector listTrainingPlanByPos(long posId, Date date, int limitStart, int recordToGet) {
        Vector lists = new Vector();
        DBResultSet dbrs = null;
