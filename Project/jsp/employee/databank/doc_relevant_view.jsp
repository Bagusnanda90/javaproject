<%-- 
    Document   : doc_relevant_view
    Created on : Dec 28, 2015, 12:10:18 PM
    Author     : Dimata 007
--%>
...
<%!
	public String drawList(Vector objectClass) {
            ...
            for (int i = 0; i < objectClass.size(); i++) {
                ...
                rowx.add("<a href=\"javascript:cmdEdit('"+empRelevantDoc.getOID()+"')\">View Attach File</a>");
                lstData.add(rowx);
            }
...
<%
    ...
    Vector listEmpRelevantDoc = PstEmpRelevantDoc.list(0, 0, whereClause , orderClause);
    Vector listCtrlEmpRelvtDocPage = PstEmpRelvtDocPage.list(0, 0, whereClausePages, orderClausePages);
%>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>Databank - <%=dictionaryD.getWord(I_Dictionary.RELEVANT_DOCS) %></title>
        ...
        <script type="text/javascript">
            function cmdEdit(oidEmpRelevantDoc){
                ...
                document.frm_relevant_doc.action="doc_relevant_view.jsp";
    ...
    <body>
        ...
        <div id="menu_utama">
            <span id="menu_title">Databank <strong style="color:#333;"> / </strong><%=dictionaryD.getWord(I_Dictionary.RELEVANT_DOCS) %></span>
        </div>
        <% if (oidEmployee != 0) {%>
            <div class="navbar">
                <ul style="margin-left: 97px">
                    ...
                    <li class="active"> <a href="doc_relevant_view.jsp" class="tablink"><%=dictionaryD.getWord(I_Dictionary.RELEVANT_DOCS) %></a> </li>
        ...
        <div class="content-main">
            <div class="box">
                <div id="box_title">Daftar <%=dictionaryD.getWord(I_Dictionary.RELEVANT_DOCS) %></div>
                <div id="box_content">
                    ...
                    <%
                    if (listEmpRelevantDoc != null & listEmpRelevantDoc.size()>0){
                        %>
                        <%= drawList(listEmpRelevantDoc)%>
                        <%
                    } else {
                        %>
