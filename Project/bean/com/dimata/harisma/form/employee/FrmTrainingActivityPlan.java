...
public class FrmTrainingActivityPlan extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_TRAINING_TITLE = 11;
    public static final int FRM_FIELD_POSITION_ID = 12;
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_REMARK", "FRM_FIELD_TRAINING_ID", "FRM_FIELD_ORGANIZER_ID", "FRM_FIELD_TRAINING_TITLE",
    ...
    public static int[] fieldTypes = {
        ...
        TYPE_INT, TYPE_INT,
        TYPE_STRING, TYPE_LONG + ENTRY_REQUIRED, TYPE_LONG, TYPE_STRING,
        TYPE_LONG
    };
    ...
    public String getFormName() {
        return FRM_NAME_TRAININGACTIVITYPLAN;
    }
    ...
    public TrainingActivityPlan getEntityObject() {
    ...
    public void requestEntityObject(TrainingActivityPlan trainingActivityPlan) {
        try {
            ...
            trainingActivityPlan.setTrainingTitle(getString(FRM_FIELD_TRAINING_TITLE));
            trainingActivityPlan.setPositionId(getLong(FRM_FIELD_POSITION_ID));
        } catch (Exception e) {
