        ...
        <% if((iCommand == Command.SAVE)) {
            ...
            for(int i=0; i<totalAttendances; i++) {                
                ...
                if(ihour != 0) {
                    ...
                    String whereClause = PstTrainingAttendancePlan.fieldNames[PstTrainingAttendancePlan.FLD_TRAIN_PLAN_ID] + "=" + oidPlan + " AND " +
                                      PstTrainingAttendancePlan.fieldNames[PstTrainingAttendancePlan.FLD_EMP_ID] + "=" + loid;
                    try{
