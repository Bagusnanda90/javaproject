...
public String drawList(Vector objectClass )
{
	...
	for (int i=0; i<objectClass.size(); i++) 
	{
		...
		rowx.add(strSubmissionDate);	
               ...
               // rowx.add(Formater.formatNumber(sumAL, "###.###"));
                
               //update by satrya 2012-10-23
              if(leaveConfig!=null && leaveConfig.isLeaveApplicationIsDay()){
                 rowx.add("<p title="+Formater.formatNumber(sumAL, "###.###")+">"+ Formater.formatWorkDayHoursMinutes(sumAL,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }else{
                rowx.add("<p title="+Formater.formatNumber(sumAL, "###.###")+">"+ Formater.formatWorkDayHoursMinutesII(sumAL,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }
                if(bUseLL){
                    // rowx.add(""+Formater.formatNumber(sumLL, "###.###")); 
              if(leaveConfig!=null && leaveConfig.isLeaveApplicationIsDay()){
                rowx.add("<p title="+Formater.formatNumber(sumLL, "###.###")+">"+ Formater.formatWorkDayHoursMinutes(sumLL,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }else {
                rowx.add("<p title="+Formater.formatNumber(sumAL, "###.###")+">"+ Formater.formatWorkDayHoursMinutesII(sumLL,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>");    
                }
              }
              if(leaveConfig!=null && leaveConfig.isLeaveApplicationIsDay()){
                 //rowx.add(""+Formater.formatNumber(sumDP, "###.###")); 
                rowx.add("<p title="+Formater.formatNumber(sumDP, "###.###")+">"+ Formater.formatWorkDayHoursMinutes(sumDP,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }else{
                rowx.add("<p title="+Formater.formatNumber(sumDP, "###.###")+">"+ Formater.formatWorkDayHoursMinutesII(sumDP,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>");
              }  
                // rowx.add(""+Formater.formatNumber(sumSpecial, "###.###")); 
              if(leaveConfig!=null && leaveConfig.isLeaveApplicationIsDay()){
                ...
                rowx.add("<p title="+Formater.formatNumber(sumSpecial, "###.###")+">"+ Formater.formatWorkDayHoursMinutesII(sumSpecial,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>");
              }
               // rowx.add(""+Formater.formatNumber(sumUnpaid, "###.###")); 		
              if(leaveConfig!=null && leaveConfig.isLeaveApplicationIsDay()){
               rowx.add("<p title="+Formater.formatNumber(sumUnpaid, "###.###")+">"+ Formater.formatWorkDayHoursMinutes(sumUnpaid,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }else{
                rowx.add("<p title="+Formater.formatNumber(sumUnpaid, "###.###")+">"+ Formater.formatWorkDayHoursMinutesII(sumUnpaid,leaveConfig.getHourOneWorkday(),leaveConfig.getFormatLeave())+"</p>"); 
              }
		lstData.add(rowx);
	}
	return ctrlist.draw();
...
//update by satrya 2013-11-08
//kasusnya ketika karyawan non hrd melakukan add form cuty lalu back sehingga dia bisa melihat semua cuty 
if((!isHRDLogin)){
 if((!isDirector)){     
    if((srcLeaveApp.getCompanyId()==0 || srcLeaveApp.getDivisionId()==0)){
        //update by satrya 2013-11-09
        //karena jika dia login dan memilih emp number atau emp full name maka yg di set sesuai kasus tsb
        
            srcLeaveApp.setDepartmentId(departmentOid); 
...
if(!isHRDLogin){
    ...
    srcLeaveApp.setEmployeeIdLeaveConfig(employeeIdLeaveConfigDinamis); 
}
...
//Vector records = sessLeaveApplication.searcsearchLeaveApplicathLeaveApplicationHR(srcLeaveApp, start, recordToGet);
    ...
    if ((namaUser2.equals("Employee"))) {
        records = sessLeaveApplication.getListEmployeeLeaveApplication(emplx.getOID());
    } else {
