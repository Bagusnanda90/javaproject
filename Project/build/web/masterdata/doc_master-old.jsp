                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Doc Master</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showdocMform" data-command="0">Add Doc Master</button>
                                          <!-- Modal -->
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/doc_master_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showdocMform'){
                        $(".addeditgeneral-title").html("Edit Doc Master");
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/doc_master_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
