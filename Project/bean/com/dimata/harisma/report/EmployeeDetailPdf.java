...
*/
            ...
            if (vFamily != null && vFamily.size() > 0) {
                ...
                titleFamilyCellTop = new Cell(new Chunk("Education", fontHeader));
                titleFamilyCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                titleFamilyCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                titleFamilyCellTop.setBorderColor(new Color(255, 255, 255));
                titleFamilyCellTop.setBackgroundColor(bgColor);
                ...
                if (vReprimand != null && vReprimand.size() > 0) {
                    ...
                    */
                    ...
                    for (int i = 0; i < vReprimand.size(); i++) {
                        ...
                        String babTitle = "";
                        int chapter = Integer.valueOf(rpm.getChapter());
                        if(chapter != 0 ){
                            vChapter = PstWarningReprimandBab.list(0,0,"BAB_ID="+rpm.getChapter(),"");
                            WarningReprimandBab warningChapter = (WarningReprimandBab)vChapter.get(i);
                            
                            babTitle = warningChapter.getBabTitle();
                        }
                        titleCellTop = new Cell(new Chunk("" + babTitle, tableContent));
                        titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titleCellTop.setBorderColor(new Color(255, 255, 255));
                        dataTable.addCell(titleCellTop);
                        ...
                        String pasalTitle = "";
                        int article = Integer.valueOf(rpm.getArticle());
                        if(article != 0){
                            vArticle = PstWarningReprimandPasal.list(0,0,"PASAL_ID="+rpm.getArticle(),"");
                            WarningReprimandPasal warningPasal = (WarningReprimandPasal)vArticle.get(i);
                            
                            pasalTitle = warningPasal.getPasalTitle();
                        }
                        titleCellTop = new Cell(new Chunk("" + pasalTitle, tableContent));
                        titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titleCellTop.setBorderColor(new Color(255, 255, 255));
                        dataTable.addCell(titleCellTop);
                        ...
                        Reprimand reprim = (Reprimand)vLvlName.get(i);
                        titleCellTop = new Cell(new Chunk("" + reprim.getReprimandDesc(), tableContent));
                        titleCellTop.setHorizontalAlignment(Element.ALIGN_LEFT);
                        titleCellTop.setVerticalAlignment(Element.ALIGN_MIDDLE);
                        titleCellTop.setBorderColor(new Color(255, 255, 255));
                        dataTable.addCell(titleCellTop);
