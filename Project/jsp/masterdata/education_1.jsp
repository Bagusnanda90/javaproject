...
<html>
    <head>
        ...
        <title>Master Education | Dimata Hairisma</title>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <br><button onfocus="test" type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showeducationform" data-command="0"> Add Education</button>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/education_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        ...
                        $(".addeditgeneral-title").html("Edit Education");
                        }

                        }else{
                            if(dataFor == 'showeducationform'){
                                $(".addeditgeneral-title").html("Add Education");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/education_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
