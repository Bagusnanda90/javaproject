...
public class ControlDate {
    ...
    public static String drawDate(String dtName, Date dtInit, String mnFormat, String cssClass, String mdDelim, String dyDelim, int mailstone, int range,String attribute) {
        ...
        String htmlSelect = "<select name=\"" + mmCtrlName + "\" id=\"m"+dtName+"\" class=\""+cssClass+"\" "+attribute+">\n";
        ...
        switch(monthFormatLength) {
            case 2 : // number format
               // if(dtInit==null){
                    htmlSelect = htmlSelect + "\t<option selected value=\"0\">-select-</option>\n";
               // }
                for(int i = 1; i <= 12; i++) {
                    if(dtInit!=null){
        ...
        // day combobox
        htmlSelect = htmlSelect + "\n<select name=\"" + ddCtrlName + "\" id=\"d"+dtName+"\" class=\""+cssClass+"\" "+attribute+">\n";
        ...
        //year combobox
        htmlSelect = htmlSelect  + "\n<select name=\"" + yyCtrlName + "\" id=\"y"+dtName+"\" class=\""+cssClass+"\""+attribute+">\n";
    ...
    public static String drawDateEmpty(String dtName, Date dtInit, String cssClass, int mailstone, int range) {
        if(dtName == null) dtName = new String("dt");
        String mnFormat = "";
        String mdDelim = "";
        String dyDelim = "";
    ...
    public static String drawDateYear(String dtName, Date dtInit, String cssClass, int mailstone, int range,String attribute) {
        if(dtName == null) dtName = new String("dt");

        String mmCtrlName = dtName;
       // String ddCtrlName = dtName + "_dy";
       // String yyCtrlName = dtName + "_yr";
        ...
        String s = "";
        if(dtInit==null){
            htmlSelect = htmlSelect + "\t<option selected value=\"\">select ...</option>\n";
        }
        for(int i = startYear; i <= endYear; i++) {
            if(dtInit!=null){
                s = (i == yyValue) ? "selected" :  "";
    ...
    public static String drawDateYear(String dtName, Date dtInit, String cssClass,int mailstone,int range)
   {
    ...
    public static String drawDateYear(String dtName, int dtInit, String cssClass,int range) {
        int startYear	= dtInit;
        int endYear = dtInit;
    ...
    public static String drawTime(String dtName, java.util.Date dtInitPar, String cssClass,
    int hrFormat, int miInterval, int secInterval) {
        //update by satrya 2012-08-01
        if(dtInitPar == null) dtInitPar = new java.util.Date();
        if(dtName == null) dtName = new String("dt");
        ...
        java.util.Date dtInit = new java.util.Date(dtInitPar.getTime());
     ...
     public static String drawTimeVer2(String dtName, java.util.Date dtInitPar, String cssClass,
    int hrFormat, int miInterval, int secInterval) {
        //update by satrya 2012-08-01
         Date dtParmeter = dtInitPar;
        if(dtInitPar == null){ 
            dtInitPar = new java.util.Date();}
        if(dtName == null) dtName = new String("dt");
        if(miInterval < 1 || miInterval > 30) miInterval = 1;
        ...
        int hrValue = dtParmeter!=null ?dtInit.getHours():0;
        int miValue = dtParmeter!=null ?dtInit.getMinutes():0;
        int secValue = dtParmeter!=null ?dtInit.getSeconds():0;
        String ampmValue = "am";
        //if((hrValue > 12) || (hrValue == 12 && miValue == 0))
        //    ampmValue = "pm";
