<%-- 
    Document   : staffrequisition
    Created on : 30-Sep-2017, 09:35:34
    Author     : Gunadi
--%>

<%@page import="com.dimata.harisma.form.recruitment.FrmStaffRequisition"%>
...
<html>
    <head>
        ...
        <title>Recruitment | Dimata Hairisma</title>
                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showRequisitionForm">
                                    <i class="fa fa-plus"></i> Add Form
                                </button>
                                <button class="btn btn-danger btndeletegeneral" data-for="requisition">
