...
<div id="tabs26">
    <ul class="menu3">
        <!-- Struktur Organisasi -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_ORGANISASI)){ %>
        ...
        <% } %>
        <!-- Penggajian -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_PAYROLL)){ %>
        ...
        <% } %>
        <!-- Kandidat -->
        <% if(userSession.checkPrivG1G2(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_CANDIDATE)){ %>
        ...
        <% } %>
        <!-- Kompetensi -->
        <% if(userSession.checkPrivG1G2(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_COMPETENCE)){ %>
        ...
        <% } %>
        <!-- Manajemen Performa -->
        <% if(userSession.checkPrivG1G2(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_PERFORMANCE)){ %>
        ...
        <% } %>
        <!-- Kinerja Karyawan -->
        <% if(userSession.checkPrivG1G2(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_ASSESSMENT) || userSession.checkPrivG1G2(AppObjInfo.G1_MENU_MASTERDATA, AppObjInfo.G2_MENU_MD_ASSESSMENT)){ %>
        ...
        <% if(userSession.checkPrivG1(AppObjInfo.G1_DOKUMEN_SURAT)){ %>
        ...
        <% } %>
        <!-- Pelatihan -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_PELATIHAN)){ %>
        ...
        <% } %>
        <!-- Absensi -->
        <% if(userSession.checkPrivG1G2(AppObjInfo.G1_MENU_EMPLOYEE, AppObjInfo.G2_MENU_ATTENDANCE) || userSession.checkPrivG1G2(AppObjInfo.G1_MENU_MASTERDATA, AppObjInfo.G2_MENU_MD_SCHEDULE) ){ %>
        ...
        <% } %>
        <!-- Lembur -->
        <% if(userSession.checkPrivG1G2(AppObjInfo.G1_PAYROLL, AppObjInfo.G2_PAYROLL_OVERTIME)){ %>
        ...
        <% } %>
        <!-- Cuti -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_EMPLOYEE)||userSession.checkPrivG1G2(AppObjInfo.G1_MASTERDATA, AppObjInfo.G2_MD_COMPANY)){ %>
        ...
        <% } %>
        <!-- Teguran -->
        <% if(userSession.checkPrivG1(AppObjInfo.G1_MENU_PERINGATAN_DAN_TEGURAN)){ %>
