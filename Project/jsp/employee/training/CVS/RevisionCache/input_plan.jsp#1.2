...
<%!
		...
		ctrlist.addHeader("Programs","","0","0");		
		ctrlist.addHeader("Total Hours","","0","0");		
		ctrlist.addHeader("Trainees","","0","0");
		ctrlist.addHeader("Trainer","","0","0");
                ctrlist.addHeader("Schedule","","0","0");
...
<!--
    ...
    function cmdEdit(oid, title,oidDep,oidTraining,trainer, remark) {        
            ...
            self.opener.document.frm_trainingplan.<%=FrmTrainingActivityActual.fieldNames[FrmTrainingActivityActual.FRM_FIELD_TRAINING_TITLE]%>.value="data trainingtitle";
