 ...
 */
public class LeaveConfigDinamisNew implements I_Leave{
    ...
    private boolean isALStockMinus = true;//update by satrya 2012-08-10 true 
...
/**
 ...
 public Vector getApprovalEmployeeTopLink(long employeeId, int typeOfLink) {
        ...
        String whereClause  = "HE." + PstEmployee.fieldNames[PstEmployee.FLD_EMPLOYEE_ID] + " = "+employeeId+" AND HMP."+ PstMappingPosition.fieldNames[PstMappingPosition.FLD_TYPE_OF_LINK] + " = "+typeOfLink ;
