...
<%!    public String drawList(int iCommand, FrmPaySlipComp frmObject, PaySlipComp objEntity, Vector objectClass, long idPaySlipComp, String codeComponent, String componentName) {
        ...
        ctrlist.addHeader("Print");
        ctrlist.addHeader("Employee Nr.");
                                                                            ...
                                                                            <td valign="top"> <!-- #BeginEditable "content" --> 
                                                                                <form name="frm_printing" method="post" action="" >
                                                                                    ...
                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                        ...
                                                                                        <tr> 
                                                                                            <td>&nbsp; </td>
                                                                                            <td height="8" width="33%" class="comment" colspan="3"><span class="comment"><br>
                                                                                                ...
                                                                                                <table>
                                                                                                    <tr>            <%if (value_search > 0) {%>
                                                                                                        <td >
                                                                                                            ...
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintHtml()" class="command">Print Selected (Format HTML)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td >
                                                                                                            <!--Untuk print all -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print All">
                                                                                                            <img src="<%//=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllHtml()" class="command">Print All  (Format HTML)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                            <!--
                                                                                                        ...
                                                                                                        <td >
                                                                                                            ...
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllText()" class="command">Print All(Format Text)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td >
                                                                                                            ...
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print All(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllCsv()" class="command">Export All to Excel</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td >
                                                                                                            ...
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print All(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllCsvPerSection()" class="command">Export All Section to Excel</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td >
                                                                                                            <!-- Untuk selected printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print All(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllCsvDifferent()" class="command">Export Different to Excel</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <%}%>		
                                                                                                        <%//}%>
                                                                                                    </tr>                    
                                                                                                    <tr> 
                                                                                                        <%if (false) { //karena belum di pakai%>
                                                                                                        <td >
                                                                                                            <% //if(compCode!=""){%>
                                                                                                            <!-- Untuk selected printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected">
                                                                                                        ...
                                                                                                        <%if (value_search > 0) {%>
                                                                                                        <td >                    
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintText()" class="command">Print Selected(Format Text)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td >                    
                                                                                                            ...
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintCsv()" class="command">Export selected to Excel</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintSelectedBinding()" class="command">Print Selected(Format Text - Binding) </a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllBinding()" class="command">Print All Format Text - Binding </a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintSelectedVersi1()" class="command">Print Selected V.1</a>
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllVersi1()" class="command">Print All V.1</a>
                                                                                                        </td>
                                                                                                    ...
                                                                                                    <tr> 
                                                                                                        ...
                                                                                                        <td>
                                                                                                            ...
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdEmailSelectedBinding()" class="command">Email Selected(Format Text) </a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdEmailAllBinding()" class="command">Email All (Format Text)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdEmailSelectedPdf()" class="command">Email Selected(PDF) </a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdEmailAllPdf()" class="command">Email All (PDF)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintSelectedPdf()" class="command">Print Selected(PDF) </a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
                                                                                                        <td>
                                                                                                            <!-- Untuk all text printing -->
                                                                                                            <img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Print Selected(Text)">
                                                                                                            <img src="<%=approot%>/images/spacer.gif" width="6" height="1">
                                                                                                            <a href="javascript:cmdPrintAllPdf()" class="command">Print All (PDF)</a> &nbsp;&nbsp; &nbsp;&nbsp;
                                                                                                        </td>
