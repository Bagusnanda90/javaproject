...
<html>
    <head>
        ...
        <title>Master Section | Dimata Hairisma</title>
                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showSectionForm">
                                    <i class="fa fa-plus"></i> Add Section
                                </button>
                                <button class="btn btn-danger btndeletegeneral" data-for="section">
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
                        $(".addeditgeneral-title").html("Edit Section");
		    }else{
                        $(".addeditgeneral-title").html("Add Section");
		    }                    
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxSection", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxSection", null, true, "json");
		...
		validateOptions("#<%= FrmSection.fieldNames[FrmSection.FRM_FIELD_SECTION] %>", 'text', 'has-error', 1, null);
                validateOptions("#<%= FrmSection.fieldNames[FrmSection.FRM_FIELD_DEPARTMENT_ID] %>", 'text', 'has-error', 1, null);
	    }
	    ...
	    function runDataTables(dataFor){
                dataTablesOptions("#sectionElement", "tableSectionElement", "AjaxSection", "listSection", callBackDataTables);
            }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletegeneral", ".<%= FrmSection.fieldNames[FrmSection.FRM_FIELD_SECTION_ID]%>");
