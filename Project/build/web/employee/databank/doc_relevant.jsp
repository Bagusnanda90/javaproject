...
<% int  appObjCode = AppObjInfo.composeObjCode(AppObjInfo.G1_EMPLOYEE, AppObjInfo.G2_DATABANK, AppObjInfo.OBJ_DATABANK_RELEVANT_DOC); %>
...
<%!
	public String drawList(Vector objectClass, long docRelevantId, boolean privUpdate)
	{
		...
		for (int i = 0; i < objectClass.size(); i++) {
			...
			if(docRelevantId == empRelevantDoc.getOID()){
                        ...
                        String dataTitle = "";
			if (privUpdate == true){
                            dataTitle = "<a href=\"javascript:cmdEdit('"+empRelevantDoc.getOID()+"')\">"+empRelevantDoc.getDocTitle()+"</a>";
                        } else {
                             dataTitle = empRelevantDoc.getDocTitle();
                        }
			rowx.add(dataTitle);
...
/*switch statement */
iErrCode = ctrlEmpRelevantDoc.action(iCommand , oidEmpRelevantDoc, oidEmployee, request, emplx.getFullName(), appUserIdSess);
/* end switch*/
                    ...
                    <table>
                                    ...
                                    <tr align="left" valign="top"> 
                                      <td valign="middle" colspan="3"> 
                                        <%= drawList(listEmpRelevantDoc,iCommand == Command.SAVE?empRelevantDoc.getOID():oidEmpRelevantDoc, privUpdate)%> </td>
                                    </tr>
                                    <%  } else { %>
                                    <tr align="left" valign="top"> 
                                      ...
                                      <td> 
                                        <table cellpadding="0" cellspacing="0" border="0">
                                          ...
                                          <tr> 
                                            ...
                                            <td width="24" height="25"><a href="javascript:cmdAdd()" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image261','','<%=approot%>/images/BtnNewOn.jpg',1)"><img name="Image261" border="0" src="<%=approot%>/images/BtnNew.jpg" width="24" height="24" alt="Add new data"></a></td>
                                            <td width="6" height="25"><img src="<%=approot%>/images/spacer.gif" width="1" height="1"></td>
                                            <td height="25" valign="middle" colspan="3" width="951">
                                                <%
                                                if (privAdd == true){
                                                    %>
                                                    <a href="javascript:cmdAdd()" class="command">Add New Relevant Document</a> 
                                                    <%
                                                }
                                                %>
                                  ...
                                  <table width="100%" border="0" cellspacing="2" cellpadding="2">
                                    ...
                                    <tr> 
                                      <td width="100%" height="216" colspan="2"> 
                                        ...
                                        <tr align="left" valign="top"> 
                                                <td width="13%" valign="top">Document 
                                                </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a style="text-decoration:none" href="javascript:cmdAttach('<%=empRelevantDoc.getOID()%>', '<%=empRelevantDoc.getEmployeeId()%>')"><font color="#30009D">Attach File</font></a>
                                                &nbsp;&nbsp;|&nbsp;&nbsp;
                                                 <a style="text-decoration:none" href ="javascript:cmdSendEmail('<%=empRelevantDoc.getOID()%>','<%=empRelevantDoc.getEmployeeId()%>')"><font color="#30009D">Send File</font></a>
                                            </td>
                                        </tr>
