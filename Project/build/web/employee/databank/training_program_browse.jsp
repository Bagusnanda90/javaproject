...
<%
    ...
    String datatargetoid = "#uppositionoid";
    String datatargetname = "#uppositionname";
    ...
    <body class="body">
        ...
        if (listTraining != null && listTraining.size()>0){
            for(int i=0; i<listTraining.size(); i++){
                ...
                %>
                <div class="item" data-oid="<%=training.getOID()%>" data-name="<%=training.getName()%>" data-target-oid="<%= datatargetoid %>" data-target-name="<%= datatargetname %>"><%=training.getName()%></div>
                <%
            }   
        }
        %>
