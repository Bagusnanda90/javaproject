...
<html>
    <head>
        ...
        <title>Master Relevant Doc Group | Dimata Hairisma</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Relevant Doc Group</li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-xs-12">
                                                <a> <h3>Relevant Doc Group List : </h3></a>
                                                <hr>
                                    ...
                                    <div class="row pull-left">
                                        <div class="col-md-12">
                                            <br><button onfocus="test" type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showreldocform" data-command="0"> Add Relevant Doc Group</button>
                                            ...
                                            <div id="mdl_delete" class="modal fade" role="dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            <h4 class="modal-title">Delete Relevant Doc Group</h4>
                                                            </div>
                                                            <div class="modal-body">
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       sendData("<%= approot %>/masterdata/ajax/relevant_doc_group_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
                        if(dataFor == 'showreldocform'){
                        $(".addeditgeneral-title").html("Edit Relevan Doc");
                        }

                        }else{
                            if(dataFor == 'showreldocform'){
                                $(".addeditgeneral-title").html("Add Relevan Doc");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/relevant_doc_group_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
