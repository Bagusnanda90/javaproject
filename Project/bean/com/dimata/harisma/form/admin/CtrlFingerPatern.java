...
public class CtrlFingerPatern
    ...
    private String getSystemMessage(int msgCode) {
        switch (msgCode) {
            case I_DBExceptionInfo.MULTIPLE_ID:
                this.frmFingerPatern.addError(frmFingerPatern.FRM_FIELD_EMPLOYEE_ID,
    ...
    public int action(int cmd, long oidFingerPatern, long oidEmployee, String oidDeleteAll) {
        msgString = "";
           ...
           case Command.DELETEALL:
                ...
                for (String asset : splits) {
                    if (asset != "") {
                        ...
                        if (oidDoc != 0) {
                            try {
                                long oid = PstFingerPatern.deleteExc(oidDoc);
                                if (oid != 0) {
                                    msgString = FRMMessage.getMessage(FRMMessage.MSG_DELETED);
                                    excCode = RSLT_OK;
                                } else {
