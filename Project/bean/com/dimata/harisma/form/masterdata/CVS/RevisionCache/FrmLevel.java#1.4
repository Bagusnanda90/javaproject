...
public class FrmLevel extends FRMHandler implements I_FRMInterface, I_FRMType {
    ...
    public static final int FRM_FIELD_MAX_LEVEL_APPROVAL = 10;
    public static final int FRM_FIELD_HR_APPROVAL = 11;
    public static String[] fieldNames = {
        ...
        "FRM_FIELD_MAX_LEVEL_APPROVAL",
        "FRM_FIELD_HR_APPROVAL"
    };
    ...
    public void requestEntityObject(Level level) {
        try {
            ...
            level.setMaxLevelApproval(getLong(FRM_FIELD_MAX_LEVEL_APPROVAL));
            level.setHr_approval(getInt(FRM_FIELD_HR_APPROVAL));
        } catch (Exception e) {
