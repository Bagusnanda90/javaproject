...
public class Employee extends Entity {
    ...
    private Date commencingDate = new Date();
...
//update by satrya 2012-11-14
     ...
     private Date probationEndDate = new Date();
    ...
    private long empDocIdGrade = 0;
    
    private String secondaryIdType = "";
    private String secondaryIdNo = "";
    private Date secondaryIDValid = new Date();
    private Date waFrom = new Date();
    private Date waTo = new Date();
    private long subSectionId = 0;
    private long waSubSectionId = 0;
    private int acknowledgeStatus = 0;
    private int fingerCheck = 0;
...
//Gede_15Nov2011{
    ...
    /**
     * @return the empDocIdGrade
     */
    public long getEmpDocIdGrade() {
        return empDocIdGrade;
    }

    /**
     * @param empDocIdGrade the empDocIdGrade to set
     */
    public void setEmpDocIdGrade(long empDocIdGrade) {
        this.empDocIdGrade = empDocIdGrade;
    }

    /**
     * @return the secondaryIdType
     */
    ...
    /**
     * @param secondaryIdType the secondaryIdType to set
     */
    ...
    /**
     * @return the secondaryIdNo
     */
    public String getSecondaryIdNo() {
        return secondaryIdNo;
    }

    /**
     * @param secondaryIdNo the secondaryIdNo to set
     */
    public void setSecondaryIdNo(String secondaryIdNo) {
        this.secondaryIdNo = secondaryIdNo;
    }

    public Date getSecondaryIDValid(){
    return secondaryIDValid;
    }

    public void setSecondaryIDValid(Date secondaryIDValid){
    this.secondaryIDValid = secondaryIDValid;
    }

    /**
     * @return the waFrom
     */
    public Date getWaFrom() {
        return waFrom;
    }

    /**
     * @param waFrom the waFrom to set
     */
    public void setWaFrom(Date waFrom) {
        this.waFrom = waFrom;
    }
    ...
    /**
     * @param waTo the waTo to set
     */
    public void setWaTo(Date waTo) {
        this.waTo = waTo;
    }
    ...
    /**
     * @return the waSubSectionId
     */
    public long getWaSubSectionId() {
        return waSubSectionId;
    }

    /**
     * @param waSubSectionId the waSubSectionId to set
     */
    public void setWaSubSectionId(long waSubSectionId) {
        this.waSubSectionId = waSubSectionId;
    }
    ...
    /**
     * @return the fingerCheck
     */
    public int getFingerCheck() {
        return fingerCheck;
    }

    /**
     * @param fingerCheck the fingerCheck to set
     */
    public void setFingerCheck(int fingerCheck) {
        this.fingerCheck = fingerCheck;
    }
