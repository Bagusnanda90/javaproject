                ...
                if (employee.getOID() == 0) {
                    try {
                        ...
                        if (oid != 0) {
                            ...
                            if (sysLog == 1) { /* kondisi jika sysLog == 1, maka proses di bawah ini dijalankan*/
                                ...
                                logCurr += ""+employee.getEmpDocId()+";";
                                logCurr += ""+employee.getHistoryGroup()+";";
                                logCurr += ""+employee.getHistoryType()+";";
                                ...
                                logSysHistory.setLogModule("Data Pribadi"); /* nama sub module*/
                    ...
                    try {
                        ...
                        if (sysLog == 1) {
                            ...
                            logPrev += ""+prevEmployee.getCountIdx()+";";
                            ...
                            logPrev += ""+prevEmployee.getEmpDocId()+";";
                            logPrev += ""+prevEmployee.getHistoryGroup()+";";
                            logPrev += ""+prevEmployee.getHistoryType()+";";
                            ...
                            logPrev = ""+prevEmployee.getOID()+";";
                            logCurr = ""+employee.getOID()+";";
                            if(employee.getIndentCardNr()!= prevEmployee.getIndentCardNr()){
                                logField += PstEmployee.fieldNames[PstEmployee.FLD_INDENT_CARD_NR]+";";
                                logPrev += ""+prevEmployee.getIndentCardNr()+";";
                                logCurr += ""+employee.getIndentCardNr()+";";
                            }
