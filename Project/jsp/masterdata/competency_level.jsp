...
<html>
    <head>
        ...
        <title>Competency level | Dimata Hairisma</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini sidebar-collapse">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                <h1> 
                    Master Data Competency Levl
                </h1>
                <ol class="breadcrumb">
                        <li><a href="../../home.jsp"><i class="fa fa-home"></i> Home</a></li>
                        <li class="active">Master Data</li>
                        <li class="active">Competency Level</li>
                </ol>
            </section>
                        ...
                        <div class="box-body">
                            <div class="row">
                                    <div class="col-xs-12">
                                        ...
                                        <br><br>
                                        <strong style="font-size: 20px">Competency Detail Level</strong>
                                          <br/>
                                          <div class="col-md-12">
                                            <hr />
                                                ...
                                                <div id="myModal" class="modal fade" role="dialog">
                                                     <div class="modal-dialog">
                                                        ...
                                                        <!-- Modal content-->
                                                            ...
                                                            <h4 class="modal-title">Form Competency Level</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                
                                                                <form role ="form">
                                                                    <div class="form-group">
                                                                        <label for="Company">Competency :</label>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <input type="text" id="" class="form-control"></input>
                                                                    </div>
                                                                    <div>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="Company">Level Unit :</label>
                                                                        <select type="email" class="form-control" id="company">
