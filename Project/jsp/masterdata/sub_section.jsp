<%-- 
    ...
    Created on : Nov 5, 2016, 11:36:40 AM
    Author     : Gunadi
--%>


<%@page import="com.dimata.harisma.form.masterdata.FrmSubSection"%>
...
<html>
    <head>
        ...
        <title>Sub Section List | Dimata Hairisma</title>
                    ...
                    <div class="col-md-12">
                        <div class='box box-primary'>
                            ...
                            <div class='box-footer'>
                                <button class="btn btn-primary btnaddgeneral" data-oid="0" data-for="showSubSectionForm">
                                    <i class="fa fa-plus"></i> Add Sub Section
                                </button>
                                <button class="btn btn-danger btndeletesubsection" data-for="subSection">
	...
	$(document).ready(function(){
		...
		$(elementId).click(function(){
		    ...
		    //SET TITLE MODAL
		    if(oid != 0){
			if(dataFor == 'showSubSectionForm'){
			    $(".addeditgeneral-title").html("Edit Sub Section");
			}

		    }else{
			if(dataFor == 'showSubSectionForm'){
			    $(".addeditgeneral-title").html("Add Sub Section");
			}
		    }
		    ...
		    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxSubSection", ".addeditgeneral-body", false, "json");
		});
	    };
		...
		$(elementId).click(function(){
			...
			if(confirm(confirmText)){
			    ...
			    getDataFunction(onDone, onSuccess, approot, command, dataSend, "AjaxSubSection", null, true, "json");
		...
		validateOptions("#<%= FrmSubSection.fieldNames[FrmSubSection.FRM_FIELD_SECTION_ID] %>", 'text', 'has-error', 1, null);
		//validateOptions("#<%= FrmSubSection.fieldNames[FrmSubSection.FRM_FIELD_SUB_SECTION] %>", 'text', 'has-error', 1, null);
	    }
		...
		dataTablesOptions("#divisionElement", "tabledivisionElement", "AjaxSubSection", "listSubSection", callBackDataTables);
	    }
	    
	    modalSetting("#addeditgeneral", "static", false, false);
	    addeditgeneral(".btnaddgeneral");
	    deletegeneral(".btndeletedivision", ".<%= FrmSubSection.fieldNames[FrmSubSection.FRM_FIELD_SUB_SECTION_ID]%>");
		...
		if(generaldatafor == "showSubSectionForm"){
		    divisionForm();
		    onDone = function(data){
			runDataTables();
		    };
