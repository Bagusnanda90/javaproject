                            ...
                            <table width="100%" align="center">
                              ...
                              <tr>
                                ...
                                <div>
                                                ...
                                                <input id="datepicker" name="<%=FrmLeaveApplication.fieldNames[FrmLeaveApplication.FRM_FLD_SUBMISSION_DATE]%>" value="<%=strdatereq %>" class="datepicker elemenForm" size="25" type="text">
                                                <%}%>
                                                </div>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                     ...
                                                     <div align="left">
                                                         ...
                                                         <!--<a href="javascript:setEmployee()">Search Employee</a>-->
                                                     </div>
                                                     </td>
                                                ...
                                                <!--newform-->
                                                     <div clas="row">
                                                         ...
                                                         <div class="col-md-3">
                                                             <div class="form-group">
                                                             <input placeholder="Payroll" type="text" name="EMP_NUMBER"  value="<%=objEmployee.getEmployeeNum()%>" class="form-control" name="" value="">
                                                             </div>
                                                             
                                                             <div class="form-group">
                                                             <input placeholder="Name" type="text" class="form-control" name="" value="">
                                                             </div>
                                                             
                                                             <div class="form-group"
                                                             <input placeholder="Division" type="text" class="form-control" name="" value="">
                                                             </div>
                                                             
                                                             <div class="form-group">
                                                             <input placeholder="Department" type="text" class="form-control" name="" value="">
                                                             </div>
                                                         ...
                                                         <div class="col-md-3">
                                                             <div class="form-group">
                                                             <input placeholder="Position" type="text" class="form-control" name="" value="">
                                                             </div>
                                                             
                                                             <div class="form-group">
                                                              <input placeholder="Commencing Date" type="text" class="form-control" name="" value="">
                                                             </div>
                                                             
                                                             <div class="form-group">
                                                              <input placeholder="Date Of Request" type="text" class="form-control" name="" value="">
                                                             </div>
                                                         </div>
                                                         </div>
                                                         ...
                                                         <div class="col-md-3">
                                                             <div class="form-group">
                                                             <input placeholder="Doc Status" type="text" class="form-control" name="" value="">
                                                             </div>
