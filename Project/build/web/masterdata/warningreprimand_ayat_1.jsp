<%-- 
    Document   : warningreprimand_ayat
    Created on : 16-Jun-2016, 09:38:08
    Author     : Gunadi
--%>
...
<html>
    <head>
        ...
        <title>Master Verse | Dimata Hairisma</title>
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <strong style="font-size: 20px">Verse List</strong>
                                            <hr />
                                ...
                                <div class="box-footer">
                                    <div class="row pull-right">
                                        <div class="col-md-12">
                                            <button type="button" class="btn btn-primary btn-sm fa fa-plus addeditdata" data-oid="0" data-for="showayatform" data-command="0"> Add New Verse</button>
            ...
            $(document).ready(function(){
                ...
                function loadData(selector){
                       ...
                       var onDone = function(data){
                           ...
                           $('#listWarningReprimandAyat').DataTable( {
                       ...
                       sendData("<%= approot %>/masterdata/ajax/warningreprimand_ayat_ajax.jsp", dataSend, onDone, onSuccess);
                ...
                function addEdit(selector){
                    ...
                    $(selector).click(function(){
                       ...
                       if(oid != 0){
			if(dataFor == 'showayatform'){
			    $(".addeditgeneral-title").html("Edit Verse");
			}

                        }else{
                            if(dataFor == 'showayatform'){
                                $(".addeditgeneral-title").html("Add Verse");
                            }
                        }
                       ...
                       sendData("<%= approot %>/masterdata/ajax/warningreprimand_ayat_ajax.jsp", dataSend1, onDone1, onSuccess1);
                    });
                }
